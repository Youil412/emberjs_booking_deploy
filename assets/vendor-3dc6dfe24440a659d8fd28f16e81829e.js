...
if(t.isRemoved)throw new Error(`The API deprecated by ${r.id} was removed in ember-source ${r.until}. The message was: ${e}. Please see ${r.url} for more details.`)},e.emberVersionGte=o,e.isRemoved=a
let s=parseFloat(t.ENV._OVERRIDE_DEPRECATION_VERSION??r.VERSION)
function o(e,t=s){let r=e.replace(/(\.0+)/g,"")
return t>=parseFloat(r)}function a(e){return o(e.until)}function l(e){return{options:e,test:!i(e),isEnabled:i(e)||a(e),isRemoved:a(e)}}e.DEPRECATIONS={DEPRECATE_IMPLICIT_ROUTE_MODEL:l({id:"deprecate-implicit-route-model",for:"ember-source",since:{available:"5.3.0",enabled:"5.3.0"},until:"6.0.0",url:"https://deprecations.emberjs.com/v5.x/#toc_deprecate-implicit-route-model"}),DEPRECATE_TEMPLATE_ACTION:l({id:"template-action",url:"https://deprecations.emberjs.com/id/template-action",until:"6.0.0",for:"ember-source",since:{available:"5.9.0",enabled:"5.9.0"}})}})),e("@ember/-internals/environment/index",["exports"],(function(e){"use strict"
...
let t=s[i]
s[i]=!0===t?!1!==e[i]:!1===t?!0===e[i]:e[i]}let{EXTEND_PROTOTYPES:t}=e
...
return new it(e)},e.isHTMLSafe=ut,Object.defineProperty(e,"isSerializationFirstNode",{enumerable:!0,get:function(){return y.isSerializationFirstNode}}),e.modifierCapabilities=void 0,e.renderSettled=function(){null===dr&&(dr=P.default.defer(),(0,R._getCurrentRunLoop)()||R._backburner.schedule("actions",null,ar))
...
return t||z}isSupportedArgument(e){return!1}onUnsupportedArgument(e){}toString(){return`<${this.constructor}:${(0,c.guidFor)(this)}>`}}const U=new WeakMap
function $(e,t){let r={create(){throw(0,n.assert)("Use constructor instead of create")},toString:()=>e.toString()}
return U.set(r,e),(0,d.setInternalComponentManager)(H,r),(0,d.setComponentTemplate)(t,r),r}const q={dynamicLayout:!1,dynamicTag:!1,prepareArgs:!1,createArgs:!0,attributeHook:!1,elementHook:!1,createCaller:!0,dynamicScope:!1,updateHook:!1,createInstance:!0,wrapped:!1,willDestroy:!1,hasSubOwner:!1}
const H=new class{getCapabilities(){return q}create(e,t,r,n,i,a){var l
let u=new(l=t,U.get(l))(e,r.capture(),(0,s.valueForRef)(a))
...
function W(e){return function(e){return e.target}(e).value}function Y(e){return void 0===e?new K(void 0):(0,s.isConstRef)(e)?new K((0,s.valueForRef)(e)):(0,s.isUpdatableRef)(e)?new Q(e):new J(e)}class K{constructor(e){this.value=e}get(){return this.value}set(e){this.value=e}}V([l.tracked],K.prototype,"value",void 0)
class Q{constructor(e){this.reference=e}get(){return(0,s.valueForRef)(this.reference)}set(e){(0,s.updateRef)(this.reference,e)}}class J{constructor(e){this.lastUpstreamValue=G,this.upstream=new Q(e)}get(){let e=this.upstream.get()
...
var Z=function(e,t,r,n){var i,s=arguments.length,o=s<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,n)
else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(o=(s<3?i(o):s>3?i(t,r,o):i(t,r))||o)
return s>3&&o&&Object.defineProperty(t,r,o),o}
let ee
...
var ne=(0,F.createTemplateFactory)({id:"Ub0nir+H",block:'[[[11,3],[16,1,[30,0,["id"]]],[16,0,[30,0,["class"]]],[16,"role",[30,0,["role"]]],[16,"title",[30,0,["title"]]],[16,"rel",[30,0,["rel"]]],[16,"tabindex",[30,0,["tabindex"]]],[16,"target",[30,0,["target"]]],[17,1],[16,6,[30,0,["href"]]],[4,[32,0],["click",[30,0,["click"]]],null],[12],[18,2,null],[13]],["&attrs","&default"],false,["yield"]]',moduleName:"packages/@ember/-internals/glimmer/lib/templates/link-to.hbs",scope:()=>[a.on],isStrictMode:!0}),ie=function(e,t,r,n){var i,s=arguments.length,o=s<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,n)
else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(o=(s<3?i(o):s>3?i(t,r,o):i(t,r))||o)
return s>3&&o&&Object.defineProperty(t,r,o),o}
const se=[],oe={}
function ae(e){return null==e}function le(e){return!ae(e)}function ue(e){return"object"==typeof e&&null!==e&&!0===e.isQueryParams}(0,n.debugFreeze)(se),(0,n.debugFreeze)(oe)
class ce extends B{constructor(){super(...arguments),this.currentRouteCache=(0,o.createCache)((()=>((0,o.consumeTag)((0,o.tagFor)(this.routing,"currentState")),(0,o.untrack)((()=>this.routing.currentRouteName)))))}static toString(){return"LinkTo"}validateArguments(){super.validateArguments()}get class(){let e="ember-view"
...
return e}return"model"in this.args.named?[this.named("model")]:se}get query(){if("query"in this.args.named){let e=this.named("query")
...
function ye(e){return"function"==typeof e}function _e(e,t){return"attrs"===t[0]&&(t.shift(),1===t.length)?(0,s.childRefFor)(e,t[0]):(0,s.childRefFromParts)(e,t)}function ve(e){let t=e.indexOf(":")
if(-1===t)return[e,e,!0]
{let r=e.substring(0,t),n=e.substring(t+1)
return[r,n,!1]}}function Oe(e,t,r,n){let[i,o,a]=r
if("id"===o){let t=(0,l.get)(e,i)
null==t&&(t=e.elementId)
let r=(0,s.createPrimitiveRef)(t)
return void n.setAttribute("id",r,!0,null)}let u=i.indexOf(".")>-1,c=u?_e(t,i.split(".")):(0,s.childRefFor)(t,i)
...
else{let t,n=i.indexOf(".")>-1,l=n?i.split("."):[],u=n?_e(e,l):(0,s.childRefFor)(e,i)
t=void 0===o?Re(u,n?l[l.length-1]:i):function(e,t,r){return(0,s.createComputeRef)((()=>(0,s.valueForRef)(e)?t:r))}(u,o,a),r.setAttribute("class",t,!1,null)}}function Re(e,t){let r
return(0,s.createComputeRef)((()=>{let n=(0,s.valueForRef)(e)
return!0===n?r||(r=(0,v.dasherize)(t)):n||0===n?String(n):null}))}function Ee(){}class ke{constructor(e,t,r,n,i,a){this.component=e,this.args=t,this.argsTag=r,this.finalizer=n,this.hasWrappedElement=i,this.isInteractive=a,this.classRef=null,this.classRef=null,this.argsRevision=null===t?0:(0,o.valueForTag)(r),this.rootRef=(0,s.createConstRef)(e,"this"),(0,O.registerDestructor)(this,(()=>this.willDestroy()),!0),(0,O.registerDestructor)(this,(()=>this.component.destroy()))}willDestroy(){let{component:e,isInteractive:t}=this
...
e(),this.finalizer=Ee}}function Ce(e){return(0,d.setInternalHelperManager)(e,{})}const Se=new WeakSet
var Te=Ce((e=>{(0,w.deprecateUntil)("Usage of the `(action)` helper is deprecated. Migrate to native functions and function invocation.",w.DEPRECATIONS.DEPRECATE_TEMPLATE_ACTION)
let t,{named:r,positional:n}=e,[i,o,...a]=n,u=o.debugLabel,c="target"in r?r.target:i,d=function(e,t){let r,n
...
return t=(0,s.isInvokableRef)(o)?Ae(o,o,Me,d,u):function(e,t,r,n,i){const o=(0,s.valueForRef)(r)
0
return(...r)=>Ae(e,(0,s.valueForRef)(t),o,n,i)(...r)}((0,s.valueForRef)(i),c,o,d,u),Se.add(t),(0,s.createUnboundRef)(t,"(result of an `action` helper)")}))
function Pe(e){return e}function Ae(e,t,r,n,i){let s,o
if("string"==typeof r){s=t
let e=t.actions?.[r]
o=e}else"function"==typeof r&&(s=e,o=r)
return(...e)=>{let t={target:s,args:e,label:"@glimmer/closure-action"}
return(0,m.flaggedInstrument)("interaction.ember-action",t,(()=>(0,R.join)(s,o,...n(e))))}}function Me(e){(0,s.updateRef)(this,e)}function xe(e){let t=Object.create(null),r=Object.create(null)
r[Ne]=e
for(let n in e){let i=e[n],o=(0,s.valueForRef)(i),a="function"==typeof o&&Se.has(o);(0,s.isUpdatableRef)(i)&&!a?t[n]=new De(i,o):t[n]=o,r[n]=o}return r.attrs=t,r}const je=Symbol("REF")
class De{constructor(e,t){this[h.MUTABLE_CELL]=!0,this[je]=e,this.value=t}update(e){(0,s.updateRef)(this[je],e)}}const Ne=(0,c.enumerableSymbol)("ARGS"),Fe=(0,c.enumerableSymbol)("HAS_BLOCK"),Ie=Symbol("DIRTY_TAG"),Le=Symbol("IS_DISPATCHING_ATTRS"),ze=Symbol("BOUNDS"),Be=(0,s.createPrimitiveRef)("ember-view");(0,n.debugFreeze)([])
...
let g=t.create(p),b=(0,m._instrumentStart)("render.component",$e,g)
...
let _=new ke(g,d,f,b,y,n)
return r.named.has("class")&&(_.classRef=r.named.get("class")),n&&y&&g.trigger("willRender"),(0,o.endUntrackFrame)(),(0,o.consumeTag)(_.argsTag),(0,o.consumeTag)(g[Ie]),_}getDebugName(e){return e.fullName||e.normalizedName||e.class?.name||e.name}getSelf({rootRef:e}){return e}didCreateElement({component:e,classRef:t,isInteractive:r,rootRef:n},i,a){(0,h.setViewElement)(e,i),(0,h.setElementView)(i,e)
let{attributeBindings:l,classNames:u,classNameBindings:d}=e
if(l&&l.length)(function(e,t,r,n){let i=[],o=e.length-1
for(;-1!==o;){let s=ve(e[o]),a=s[1];-1===i.indexOf(a)&&(i.push(a),Oe(t,r,s,n)),o--}if(-1===i.indexOf("id")){let e=t.elementId?t.elementId:(0,c.guidFor)(t)
n.setAttribute("id",(0,s.createPrimitiveRef)(e),!1,null)}})(l,e,n,a)
else{let t=e.elementId?e.elementId:(0,c.guidFor)(e)
a.setAttribute("id",(0,s.createPrimitiveRef)(t),!1,null)}if(t){const e=Re(t)
a.setAttribute("class",e,!1,null)}u&&u.length&&u.forEach((e=>{a.setAttribute("class",(0,s.createPrimitiveRef)(e),!1,null)})),d&&d.length&&d.forEach((e=>{we(n,e,a)})),a.setAttribute("class",Be,!1,null),"ariaRole"in e&&a.setAttribute("role",(0,s.childRefFor)(n,"ariaRole"),!1,null),e._transitionTo("hasElement"),r&&((0,o.beginUntrackFrame)(),e.trigger("willInsertElement"),(0,o.endUntrackFrame)())}didRenderLayout(e,t){e.component[ze]=t,e.finalize()}didCreate({component:e,isInteractive:t}){t&&(e._transitionTo("inDOM"),e.trigger("didInsertElement"),e.trigger("didRender"))}update(e){let{component:t,args:r,argsTag:n,argsRevision:i,isInteractive:s}=e
if(e.finalizer=(0,m._instrumentStart)("render.component",qe,t),(0,o.beginUntrackFrame)(),null!==r&&!(0,o.validateTag)(n,i)){(0,o.beginTrackFrame)()
let i=xe(r)
n=e.argsTag=(0,o.endTrackFrame)(),e.argsRevision=(0,o.valueForTag)(n),t[Le]=!0,t.setProperties(i),t[Le]=!1,t.trigger("didUpdateAttrs"),t.trigger("didReceiveAttrs")}s&&(t.trigger("willUpdate"),t.trigger("willRender")),(0,o.endUntrackFrame)(),(0,o.consumeTag)(n),(0,o.consumeTag)(t[Ie])}didUpdateLayout(e){e.finalize()}didUpdate({component:e,isInteractive:t}){t&&(e.trigger("didUpdate"),e.trigger("didRender"))}getDestroyable(e){return e}}function $e(e){return e.instrumentDetails({initialRender:!0})}function qe(e){return e.instrumentDetails({initialRender:!1})}const He={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!0,elementHook:!0,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0,wrapped:!0,willDestroy:!0,hasSubOwner:!1},Ve=new Ue
function Ge(e){return e===Ve}let We=new WeakMap
class Ye extends(h.CoreView.extend(h.ChildViewsSupport,h.ViewStateSupport,h.ClassNamesSupport,b.TargetActionSupport,h.ActionSupport,h.ViewMixin,{didReceiveAttrs(){},didRender(){},didUpdate(){},didUpdateAttrs(){},willRender(){},willUpdate(){}})){constructor(){super(...arguments),this.isComponent=!0}init(e){super.init(e),this._superRerender=this.rerender,this.rerender=this._rerender,this[Le]=!1,this[Ie]=(0,o.createTag)(),this[ze]=null
...
this.__dispatcher=t}else this.__dispatcher=null}return this.__dispatcher}on(e,t,r){return this._dispatcher?.setupHandlerForEmberEvent(e),super.on(e,t,r)}_rerender(){(0,o.dirtyTag)(this[Ie]),this._superRerender()}[l.PROPERTY_DID_CHANGE](e,t){if(this[Le])return
...
return n||"attr"===i?r.getAttribute(s):r[s]}static toString(){return"@ember/component"}}var Ke
e.Component=Ye,Ye.isComponentFactory=!0,Ye.reopenClass({positionalParams:[]}),(0,d.setInternalComponentManager)(Ve,Ye)
const Qe=Symbol("RECOMPUTE_TAG"),Je=Symbol("IS_CLASSIC_HELPER")
class Xe extends E.FrameworkObject{init(e){super.init(e),this[Qe]=(0,o.createTag)()}recompute(){(0,R.join)((()=>(0,o.dirtyTag)(this[Qe])))}}e.Helper=Xe,Ke=Je,Xe.isHelperFactory=!0,Xe[Ke]=!0,Xe.helper=nt
...
return(0,o.consumeTag)(e[Qe]),i}getDebugName(e){return(0,c.getDebugName)((e.class||e).prototype)}}(0,d.setHelperManager)((e=>new Ze(e)),Xe)
...
const st={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},ot=/[&<>"'`=]/,at=/[&<>"'`=]/g
function lt(e){return st[e]}function ut(e){return null!==e&&"object"==typeof e&&"toHTML"in e&&"function"==typeof e.toHTML}function ct(e){return{object:`${e.name}:main`}}const dt={dynamicLayout:!1,dynamicTag:!1,prepareArgs:!1,createArgs:!1,attributeHook:!1,elementHook:!1,createCaller:!1,dynamicScope:!0,updateHook:!1,createInstance:!0,wrapped:!1,willDestroy:!1,hasSubOwner:!1}
class ht{create(e,t,r,n,i){let o=i.get("outletState"),a=t.ref
i.set("outletState",a)
let l={self:(0,s.createConstRef)(t.controller,"this"),finalize:(0,m._instrumentStart)("render.outlet",ct,t)}
...
this.capabilities=(0,d.capabilityFlagsFrom)(r),this.compilable=r.wrapped?(0,_.unwrapTemplate)(e.template).asWrappedLayout():(0,_.unwrapTemplate)(e.template).asLayout(),this.resolvedName=e.name}}class mt extends Ue{constructor(e){super(),this.component=e}create(e,t,r,{isInteractive:n},i){let s=this.component,a=(0,m._instrumentStart)("render.component",$e,s)
i.view=s
let l=""!==s.tagName
l||(n&&s.trigger("willRender"),s._transitionTo("hasElement"),n&&s.trigger("willInsertElement"))
let u=new ke(s,null,o.CONSTANT_TAG,a,l,n)
return(0,o.consumeTag)(s[Ie]),u}}const gt={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!1,createArgs:!1,attributeHook:!0,elementHook:!0,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0,wrapped:!0,willDestroy:!1,hasSubOwner:!1}
...
this.state=t}}class yt{constructor(e){this.inner=e}}var _t=Ce((({positional:e})=>{const t=e[0]
return(0,s.createComputeRef)((()=>{let e=(0,s.valueForRef)(t)
return(0,o.consumeTag)((0,l.tagForObject)(e)),(0,c.isProxy)(e)&&(e=(0,b._contentFor)(e)),new yt(e)}))}))
...
return e.forEach((function(e,s){i=i||arguments.length>=2,i&&t.push(s),r.push(e),n++})),0===n?null:i?new this(t,r):new Ot(r)}constructor(e,t){super(t.length),this.keys=e,this.values=t}valueFor(e){return this.values[e]}memoFor(e){return this.keys[e]}}class Et{static from(e){let t=e[Symbol.iterator](),r=t.next(),{done:n}=r
...
return this.position++,this.result=e.next(),{value:n,memo:i}}}class kt extends Et{valueFor(e){return e.value}memoFor(e,t){return t}}class Ct extends Et{valueFor(e){return e.value[1]}memoFor(e){return e.value[0]}}function St(e){return null!=e&&"function"==typeof e.forEach}function Tt(e){return null!=e&&"function"==typeof e[Symbol.iterator]}(0,M.default)({FEATURES:{DEFAULT_HELPER_MANAGER:!0},scheduleRevalidate(){R._backburner.ensureInstance()},toBool:function(e){return(0,c.isProxy)(e)?((0,o.consumeTag)((0,l.tagForProperty)(e,"content")),Boolean((0,l.get)(e,"isTruthy"))):(0,D.isArray)(e)?((0,o.consumeTag)((0,l.tagForProperty)(e,"[]")),0!==e.length):(0,j.isHTMLSafe)(e)?Boolean(e.toString()):Boolean(e)},toIterator:function(e){return e instanceof yt?function(e){if(t=e,null===t||"object"!=typeof t&&"function"!=typeof t)return null
var t
return Array.isArray(e)||(0,x.isEmberArray)(e)?Rt.fromIndexable(e):Tt(e)?Ct.from(e):St(e)?Rt.fromForEachable(e):Rt.fromIndexable(e)}(e.inner):function(e){if(!(0,c.isObject)(e))return null
return Array.isArray(e)?Ot.from(e):(0,x.isEmberArray)(e)?wt.from(e):Tt(e)?kt.from(e):St(e)?Ot.fromForEachable(e):null}(e)},getProp:l._getProp,setProp:l._setProp,getPath:l.get,setPath:l.set,scheduleDestroy(e,t){(0,R.schedule)("actions",null,t,e)},scheduleDestroyed(e){(0,R.schedule)("destroy",null,e)},warnIfStyleNotTrusted(e){},assert(e,t,r){0},deprecate(e,t,r){0}})
class Pt{constructor(e,t){this.owner=e,this.isInteractive=t,this.enableDebugTooling=C.ENV._DEBUG_RENDER_TREE}onTransactionCommit(){}}var At=Ce((({positional:e,named:t})=>{const r=e[0]
...
return t}
var xt=Ce(Mt),jt=Ce((({positional:e})=>(0,s.createComputeRef)((()=>{let t=e[0],r=e[1],n=(0,s.valueForRef)(t).split("."),i=n[n.length-1],o=(0,s.valueForRef)(r)
return!0===o?(0,v.dasherize)(i):o||0===o?String(o):""})))),Dt=Ce((({positional:e},t)=>{let r=e[0],n=(0,s.valueForRef)(r)
return(0,s.createConstRef)(t.factoryFor(n)?.class,`(-resolve "${n}")`)})),Nt=Ce((({positional:e})=>{const t=e[0]
return(0,s.createComputeRef)((()=>{let e=(0,s.valueForRef)(t)
return(0,c.isObject)(e)&&(0,o.consumeTag)((0,l.tagForProperty)(e,"[]")),e}))})),Ft=Ce((({positional:e})=>{let t=e[0]
return(0,s.createInvokableRef)(t)})),It=Ce((({positional:e})=>{let t=e[0]
return(0,s.createReadOnlyRef)(t)})),Lt=Ce((({positional:e,named:t})=>(0,s.createUnboundRef)((0,s.valueForRef)(e[0]),"(result of an `unbound` helper)"))),zt=Ce((()=>(0,s.createConstRef)(Bt(),"unique-id")))
function Bt(){return([3e7]+-1e3+-4e3+-2e3+-1e11).replace(/[0-3]/g,(e=>(4*e^16*Math.random()>>(2&e)).toString(16)))}const Ut=["alt","shift","meta","ctrl"],$t=/^click|mouse|touch/
let qt={registeredActions:h.ActionManager.registeredActions,registerAction(e){let{actionId:t}=e
...
class Ht{constructor(e,t,r,n,i,s){this.tag=(0,o.createUpdatableTag)(),this.element=e,this.owner=t,this.actionId=r,this.actionArgs=n,this.namedArgs=i,this.positional=s,this.eventName=this.getEventName(),(0,O.registerDestructor)(this,(()=>qt.unregisterAction(this)))}getEventName(){let{on:e}=this.namedArgs
...
return!function(e,t){if(null==t){if($t.test(e.type))return(0,h.isSimpleClick)(e)
t=""}if(t.indexOf("any")>=0)return!0
for(let r=0;r<Ut.length;r++)if(e[Ut[r]+"Key"]&&-1===t.indexOf(Ut[r]))return!1
return!0}(e,u)||(!1!==l&&e.preventDefault(),d||e.stopPropagation(),(0,R.join)((()=>{let e=this.getActionArgs(),r={args:e,target:c,name:null};(0,s.isInvokableRef)(t)?(0,m.flaggedInstrument)("interaction.ember-action",r,(()=>{(0,s.updateRef)(t,e[0])})):"function"!=typeof t?(r.name=t,c.send?(0,m.flaggedInstrument)("interaction.ember-action",r,(()=>{c.send.apply(c,[t,...e])})):(0,m.flaggedInstrument)("interaction.ember-action",r,(()=>{c[t].apply(c,e)}))):(0,m.flaggedInstrument)("interaction.ember-action",r,(()=>{t.apply(c,e)}))})),d)}}const Vt=new class{create(e,t,r,{named:n,positional:i}){let s=[]
for(let a=2;a<i.length;a++)s.push(i[a])
let o=(0,c.uuid)()
return new Ht(t,e,o,s,n,i)}getDebugInstance(){return null}getDebugName(){return"action"}install(e){(0,w.deprecateUntil)("Usage of the `{{action}}` modifier is deprecated. Migrate to native functions and function invocation.",w.DEPRECATIONS.DEPRECATE_TEMPLATE_ACTION)
let t,r,n,{element:i,actionId:o,positional:a}=e
a.length>1&&(n=a[0],r=a[1],t=(0,s.isInvokableRef)(r)?r:(0,s.valueForRef)(r)),e.actionName=t,e.implicitTarget=n,this.ensureEventSetup(e),qt.registerAction(e),i.setAttribute("data-ember-action",""),i.setAttribute(`data-ember-action-${o}`,String(o))}update(e){let{positional:t}=e,r=t[1];(0,s.isInvokableRef)(r)||(e.actionName=(0,s.valueForRef)(r)),e.getEventName()!==e.eventName&&(this.ensureEventSetup(e),e.eventName=e.getEventName())}ensureEventSetup(e){let t=e.owner.lookup("event_dispatcher:main")
...
return(0,_.unwrapTemplate)(t(e.engine)).asLayout()}getCapabilities(){return Wt}getOwner(e){return e.engine}create(e,{name:t},r,n){let i=e.buildChildEngineInstance(t)
i.boot()
let o,a,l,u,c=i.factoryFor("controller:application")||(0,N.generateControllerFactory)(i,"application")
...
class Kt{constructor(e){this.resolvedName=e,this.handle=-1,this.manager=Yt,this.compilable=null,this.capabilities=(0,d.capabilityFlagsFrom)(Wt),this.state={name:e}}}const Qt=Ce(((e,t)=>{let r,n,i,o=e.positional[0]
return r=(0,y.createCapturedArgs)(e.named,y.EMPTY_POSITIONAL),(0,s.createComputeRef)((()=>{let e=(0,s.valueForRef)(o)
return"string"==typeof e?(n===e||(n=e,i=(0,y.curry)(S.CurriedType.Component,new Kt(e),t,r,!0)),i):(i=null,n=null,null)}))})),Jt=Ce(((e,t,r)=>{let n=(0,s.createComputeRef)((()=>{let e=(0,s.valueForRef)(r.get("outletState"))
...
o=(0,y.curry)(S.CurriedType.Component,new ft(r),e?.render?.owner??t,c,!0)}else o=null
return o}))}))
function Xt(e){return{object:`component:${e}`}}const Zt={action:Te,mut:Ft,readonly:It,unbound:Lt,"-hash":y.hash,"-each-in":_t,"-normalize-class":jt,"-resolve":Dt,"-track-array":Nt,"-mount":Qt,"-outlet":Jt,"-in-el-null":xt},er={...Zt,array:y.array,concat:y.concat,fn:y.fn,get:y.get,hash:y.hash,"unique-id":zt}
...
a={state:Ge(n)?e:t,manager:n,template:i}}return o(),this.componentDefinitionCache.set(n,a),a}}const ir="-top-level"
class sr{static extend(e){return class extends sr{static create(t){return t?super.create(Object.assign({},e,t)):super.create(e)}}}static reopenClass(e){Object.assign(this,e)}static create(e){let{environment:t,application:r,template:n}=e,i=(0,u.getOwner)(e),s=n(i)
return new sr(t,i,s,r)}constructor(e,t,r,n){this._environment=e,this.owner=t,this.template=r,this.namespace=n
let i=(0,o.createTag)(),a={outlets:{main:void 0},render:{owner:t,into:void 0,outlet:"main",name:ir,controller:void 0,model:void 0,template:r}},l=this.ref=(0,s.createComputeRef)((()=>((0,o.consumeTag)(i),a)),(e=>{(0,o.dirtyTag)(i),a.outlets.main=e}))
this.state={ref:l,name:ir,template:r,controller:void 0,model:void 0}}appendTo(e){let t
t=this._environment.hasDOM&&"string"==typeof e?document.querySelector(e):e
let r=this.owner.lookup("renderer:-dom");(0,R.schedule)("render",r,"appendOutletView",this,t)}rerender(){}setOutletState(e){(0,s.updateRef)(this.ref,e)}destroy(){}}e.OutletView=sr
class or{constructor(e,t){this.view=e,this.outletState=t}child(){return new or(this.view,this.outletState)}get(e){return this.outletState}set(e,t){return this.outletState=t,t}}const ar=()=>{}
class lr{constructor(e,t,r,n,i,s,o,a,l){this.root=e,this.runtime=t,this.id=e instanceof sr?(0,c.guidFor)(e):(0,h.getViewId)(e),this.result=void 0,this.destroyed=!1,this.render=()=>{let e=(0,_.unwrapTemplate)(i).asLayout(),u=(0,y.renderMain)(t,r,n,s,l(t.env,{element:o,nextSibling:null}),e,a),c=this.result=u.sync()
...
let hr=0
R._backburner.on("begin",(function(){for(let e of ur)e._scheduleRevalidate()})),R._backburner.on("end",(function(){for(let e of ur)if(!e._isValid()){if(hr>C.ENV._RERENDER_LOOP_LIMIT)throw hr=0,e.destroy(),new Error("infinite rendering invalidation detected")
return hr++,R._backburner.join(null,ar)}hr=0,function(){if(null!==dr){let e=dr.resolve
dr=null,R._backburner.join(null,e)}}()}))
class pr{static create(e){let{_viewRegistry:t}=e,r=(0,u.getOwner)(e),n=r.lookup("service:-document"),i=r.lookup("-environment:main"),s=r.lookup(k.privatize`template:-root`),o=r.lookup("service:-dom-builder")
...
let a=this._runtimeResolver=new nr,l=(0,T.artifacts)()
...
return e}appendOutletView(e,t){let r=function(e){if(C.ENV._APPLICATION_TEMPLATE_WRAPPER){const t=Object.assign({},dt,{dynamicTag:!0,elementHook:!0,wrapped:!0}),r=new class extends ht{getTagName(){return"div"}getCapabilities(){return t}didCreateElement(e,t){t.setAttribute("class","ember-view"),t.setAttribute("id",(0,c.guidFor)(e))}}
return new ft(e.state,r)}return new ft(e.state)}(e)
this._appendDefinition(e,(0,y.curry)(S.CurriedType.Component,r,e.owner,null,!0),t)}appendTo(e,t){let r=new bt(e)
this._appendDefinition(e,(0,y.curry)(S.CurriedType.Component,r,this._owner,null,!0),t)}_appendDefinition(e,t,r){let n=(0,s.createConstRef)(t,"this"),i=new or(null,s.UNDEFINED_REFERENCE),o=new lr(e,this._runtime,this._context,this._owner,this._rootTemplate,n,r,i,this._builder)
...
this._removedRoots.length=0,this._roots=[],e.length&&cr(this)}_scheduleRevalidate(){R._backburner.scheduleOnce("render",this,this._revalidate)}_isValid(){return this._destroyed||0===this._roots.length||(0,o.validateTag)(o.CURRENT_TAG,this._lastRevision)}_revalidate(){this._isValid()||this._renderRootsTransaction()}}e.Renderer=pr
let fr={}
var mr=(0,F.createTemplateFactory)({id:"2c6+lAmT",block:'[[[46,[28,[32,0],null,null],null,null,null]],[],false,["component"]]',moduleName:"packages/@ember/-internals/glimmer/lib/templates/outlet.hbs",scope:()=>[Jt],isStrictMode:!0})
...
i.set(r,{count:1,path:n,tag:o,lastRevision:(0,s.valueForTag)(o),suspended:!1})}}let R=!1,E=[]
function k(e,t,r=!1){if(!0===R)return void E.push([e,t,r])
...
null!==s&&(s.isInitializing()||s.isPrototypeMeta(e))||(x(e,r),D<=0&&T(),j in e&&(4===arguments.length?e[j](r,i):e[j](r)))}function F(){D++,R=!0}function I(){D--,D<=0&&(T(),function(){R=!1
...
function Oe(e){return"object"==typeof e&&null!==e&&"function"==typeof e.unknownProperty}function we(e,t){return ve(t)?Ee(e,t):Re(e,t)}function Re(e,t){if(null==e)return
let r
...
e=Re(e,i)}return e}Re("foo","a"),Re("foo",1),Re({},"a"),Re({},1),Re({unknownProperty(){}},"a"),Re({unknownProperty(){}},1),we({},"foo"),we({},"foo.bar")
let ke={}
...
return null!==s&&te.has(s.set)?(e[t]=n,n):(i=e[t],void 0!==i||"object"!=typeof e||t in e||"function"!=typeof e.setUnknownProperty?(e[t]=n,i!==n&&N(e,t)):e.setUnknownProperty(t,n),n)}(0,r.setProxy)(ke),(0,s.track)((()=>Re({},"a"))),(0,s.track)((()=>Re({},1))),(0,s.track)((()=>Re({a:[]},"a"))),(0,s.track)((()=>Re({a:ke},"a")))
...
return k.call(t)},e.uuid=s,e.wrap=function(e,t){if(!b(e))return e
...
let n=_.get(e)
return void 0!==n&&_.set(r,n),r}function R(e,t){let r=e
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=e.NativeArray=e.MutableArray=e.A=void 0,e.isArray=R,Object.defineProperty(e,"makeArray",{enumerable:!0,get:function(){return d.default}}),e.removeAt=O,e.uniqBy=f
...
return r<0&&(r+=i),g(e,n&&t!=t?e=>e!=e:e=>e===t,r)}function O(e,r,n){return(0,t.replace)(e,r,n??1,h),e}function w(e,r,n){return(0,t.replace)(e,r,0,[n]),n}function R(e){if(!e||e.setInterval)return!1
...
return this.forEach(((n,i,s)=>r[i]=e.call(t,n,i,s))),r},mapBy:k,filter(e,t=null){let r=A()
...
return t._without=e,t}keys(){let e=R(this)
...
let n=e.mixins
return!!n&&n.some((e=>w(e,t,r)))}function R(e,t=new Set,r=new Set){if(!r.has(e)){if(r.add(e),e.properties){let r=Object.keys(e.properties)
for(let e of r)t.add(e)}else e.mixins&&e.mixins.forEach((e=>R(e,t,r)))
...
Object.defineProperty(e,"__esModule",{value:!0})})),e("@ember/routing/route",["exports","@ember/-internals/container","@ember/-internals/metal","@ember/-internals/owner","@ember/-internals/environment","@ember/routing/-internals","@ember/object","@ember/object/evented","@ember/array","@ember/-internals/runtime","@ember/utils","@ember/-internals/utils","@ember/controller","@ember/debug","@ember/-internals/deprecations","@ember/engine/instance","@ember/object/compat","@ember/runloop","router_js","@ember/routing/router","@ember/routing/lib/utils"],(function(e,t,r,n,i,s,o,a,l,u,c,d,h,p,f,m,g,b,y,_,v){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.defaultSerialize=e.default=void 0,e.getFullQueryParams=C,e.getRenderState=function(e){return e[E]},e.hasDefaultSerialize=function(e){return e.serialize===A}
var O,w=function(e,t,r,n){var i,s=arguments.length,o=s<3?t:null===n?n=Object.getOwnPropertyDescriptor(t,r):n
if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,n)
else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(o=(s<3?i(o):s>3?i(t,r,o):i(t,r))||o)
return s>3&&o&&Object.defineProperty(t,r,o),o}
const R=Symbol("render"),E=Symbol("render-state")
class k extends(o.default.extend(u.ActionHandler,a.default)){constructor(e){if(super(e),this.context={},this[O]=void 0,e){let r=e.lookup("router:main"),n=e.lookup(t.privatize`-bucket-cache:main`)
...
if(void 0===r)return{}
let i=this._router._routerMicrolib.activeTransition,s=i?i[y.STATE_SYMBOL]:this._router._routerMicrolib.state,o=r.fullRouteName,a={...s.params[o]},l=S(r,s)
...
r._qpDelegate=(0,o.get)(this,"_qp").states.inactive,this.resetController(r,e,t)}enter(e){this[E]=void 0,this.activate(e),this.trigger("activate",e)}deactivate(e){}activate(e){}intermediateTransitionTo(...e){let[t,...r]=(0,v.prefixRouteNameArg)(this,e)
...
null===n||"function"!=typeof n.get&&"function"!=typeof n.set||(0,r.defineProperty)(e,t,(0,g.dependentKeyCompat)({get:n.get,set:n.set}))}(0,r.addObserver)(e,`${t}.[]`,e,e._qpChanged,!1)}))})(i,e),this.controller=i}let a=s.states
if(i._qpDelegate=a.allowOverrides,t){(0,v.stashParamNames)(this._router,t[y.STATE_SYMBOL].routeInfos)
...
let n=S(this,t[y.STATE_SYMBOL]);(0,o.setProperties)(i,n)}this.setupController(i,e,t),this._environment.options.shouldRender&&this[R](),(0,r.flushAsyncObservers)(!1)}_qpChanged(e,t,r){if(!r)return
...
if(Object.prototype.hasOwnProperty.call(i.resolvedModels,e))return i.resolvedModels[e]}return s?.currentModel}[(O=E,R)](){this[E]=function(e){let t=(0,n.getOwner)(e)
...
return e._deserializeQueryParams(t.routeInfos,n),r&&(t.fullQueryParams=n),n}function S(e,t){t.queryParamsFor=t.queryParamsFor||{}
let r=e.fullRouteName,n=t.queryParamsFor[r]
if(n)return n
let i=C(e._router,t),s=t.queryParamsFor[r]={},a=(0,o.get)(e,"_qp").qps
for(let o of a){let e=o.prop in i
s[o.prop]=e?i[o.prop]:T(o.defaultValue)}return s}function T(e){return Array.isArray(e)?(0,l.A)(e.slice()):e}function P(e,t){if(e.routable){let r=e.mountPoint
return"application"===t?r:`${r}.${t}`}return t}k.isRouteFactory=!0,w([o.computed],k.prototype,"_store",null),w([o.computed],k.prototype,"_qp",null)
...
e.default=k})),e("@ember/routing/router-service",["exports","@ember/-internals/owner","@ember/object/evented","@ember/debug","@ember/object/computed","@ember/service","@glimmer/validator","@ember/routing/router","@ember/routing/lib/utils"],(function(e,t,r,n,i,s,o,a,l){"use strict"
...
function f(e){C(this),this._cancelSlowTransitionTimer(),this.notifyPropertyChange("url"),this.set("currentState",this.targetState)}function m(e,t){0}function g(){return this}Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0,e.triggerEvent=E
...
return R(r,o,`${i}_${t}`,a)?a:""}function w(e,t){let r=(0,n.getOwner)(e),{routeName:i,fullRouteName:s,_router:o}=e,a="application"===s?t:`${s}.${t}`
return R(r,o,"application"===i?t:`${i}.${t}`,a)?a:""}function R(e,t,r,n){let i=t.hasRoute(n),s=e.factoryFor(`template:${r}`)||e.factoryFor(`route:${r}`)
...
else if(!a&&!t)throw new Error(`Nothing handled the action '${r}'. If you did handle the action, this error can be caused by returning true from an action handler in a controller, causing the action to bubble.`)}function k(e,t,r){let n=e._routerMicrolib.applyIntent(t,r),{routeInfos:i,params:s}=n
...
return r.join("\n\n")},e.buildSingleMeta=h,e.check=function(e,t,r=k){if("function"==typeof t)return t(e),e
...
return!0}expected(){return"a primitive"}}function R(e){return new v(e)}function E(e){return new O(e)}function k(e,t){return`Got ${e}, expected:\n${t}`}let C=0
...
const S=e.CheckNumber=new f("number"),T=e.CheckBoolean=new f("boolean"),P=(e.CheckHandle=S,e.CheckString=new f("string")),A=(e.CheckNull=new class{validate(e){return null===e}expected(){return"null"}},e.CheckUndefined=new class{validate(e){return void 0===e}expected(){return"undefined"}},e.CheckUnknown=new class{constructor(){this.type=void 0}validate(e){return!0}expected(){return"any"}})
...
function M(e,t=String(e)){return new _(e,t)}e.CheckBlockSymbolTable=R({parameters:E(S)}),e.CheckProgramSymbolTable=R({hasEval:T,symbols:E(P)}),e.CheckElement=R({nodeType:M(1),tagName:P,nextSibling:A}),e.CheckDocumentFragment=R({nodeType:M(11),nextSibling:A}),e.CheckNode=R({nodeType:S,nextSibling:A})})),e("@glimmer/destroyable",["exports","@glimmer/global-context","@glimmer/util"],(function(e,t,r){"use strict"
...
const r=k(O,e)
if(void 0===r&&!0===t)return null
return r},e.hasCapability=function(e,t){return(0,s.check)(e,s.CheckNumber),!!(e&t)},e.hasDestroyable=b,e.hasInternalComponentManager=function(e){return void 0!==k(v,e)},e.hasInternalHelperManager=function(e){return function(e){return"function"==typeof e}(e)||void 0!==k(w,e)},e.hasInternalModifierManager=function(e){return void 0!==k(O,e)},e.hasValue=g,e.helperCapabilities=function(e,t={}){0
0
0
...
class _{constructor(){this.capabilities={hasValue:!0,hasDestroyable:!1,hasScheduledEffect:!1}}createHelper(e,t){return{fn:e,args:t}}getValue({fn:e,args:t}){if(Object.keys(t.named).length>0){return e(...[...t.positional,t.named])}return e(...t.positional)}getDebugName(e){return e.name?`(helper function ${e.name})`:"(anonymous helper function)"}}const v=new WeakMap,O=new WeakMap,w=new WeakMap,R=Object.getPrototypeOf
function E(e,t,r){return e.set(r,t),r}function k(e,t){let r=t
for(;null!=r;){const t=e.get(r)
if(void 0!==t)return t
r=R(r)}}function C(e,t){return E(O,e,t)}function S(e,t){return E(w,e,t)}const T=new y((()=>new _))
function P(e,t){return E(v,e,t)}const A={dynamicLayout:!1,dynamicTag:!1,prepareArgs:!1,createArgs:!0,attributeHook:!1,elementHook:!1,createCaller:!1,dynamicScope:!0,updateHook:!0,createInstance:!0,wrapped:!1,willDestroy:!1,hasSubOwner:!1}
...
return o={tag:(0,i.createUpdatableTag)(),element:t,delegate:a,args:l,modifier:u},(0,r.registerDestructor)(o,(()=>a.destroyModifier(u,l))),o}getDebugName(e){return"function"==typeof e?e.name||e.toString():"<unknown>"}getDebugInstance({modifier:e}){return e}getTag({tag:e}){return e}install({element:e,args:r,modifier:n,delegate:s}){let{capabilities:o}=s
...
return i.setAttribute("glmr",t),n.insertBefore(e,i,r),super.pushRemoteElement(e,t,r)}}})),e("@glimmer/opcode-compiler",["exports","@glimmer/util","@glimmer/debug","@glimmer/vm","@glimmer/encoder","@glimmer/wire-format","@glimmer/manager"],(function(e,t,r,n,i,s,o){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.WrappedBuilder=e.StdLib=e.MINIMAL_CAPABILITIES=e.EMPTY_BLOCKS=e.DEFAULT_CAPABILITIES=e.CompileTimeCompilationContextImpl=void 0,e.compilable=fe,e.compileStatements=me,e.compileStd=re,e.debugCompiler=void 0,e.invokeStaticBlock=q,e.invokeStaticBlockWithStack=H,e.meta=z,e.programCompilationContext=function(e,t,r){return new se(e,t,r)},e.templateCacheCounters=void 0,e.templateCompilationContext=oe,e.templateFactory=function({id:e,moduleName:t,block:r,scope:n,isStrictMode:i}){let s,o=e||"client-"+be++,a=null,l=new WeakMap,u=e=>{if(void 0===s&&(s=JSON.parse(r)),void 0===e)return null===a?(ye.cacheMiss++,a=new _e({id:o,block:s,moduleName:t,owner:null,scope:n,isStrictMode:i})):ye.cacheHit++,a
let u=l.get(e)
return void 0===u?(ye.cacheMiss++,u=new _e({id:o,block:s,moduleName:t,owner:e,scope:n,isStrictMode:i}),l.set(e,u)):ye.cacheHit++,u}
...
let r=t[0]
return r===s.SexpOpcodes.GetStrictKeyword||r===s.SexpOpcodes.GetLexicalSymbol||r===e}}const l=a(s.SexpOpcodes.GetFreeAsComponentHead),u=a(s.SexpOpcodes.GetFreeAsModifierHead),c=a(s.SexpOpcodes.GetFreeAsHelperHead),d=a(s.SexpOpcodes.GetFreeAsComponentOrHelperHead)
function h(e,r,n,i,s){let{upvars:o}=n,a=(0,t.unwrap)(o[e[1]]),l=r.lookupBuiltInHelper(a)
...
function g(e){return{type:m.Label,value:e}}function b(){return{type:m.IsStrictMode,value:void 0}}function y(e){return{type:m.StdLib,value:e}}function _(e){return{type:m.SymbolTable,value:e}}function v(e){return{type:m.Layout,value:e}}class O{constructor(){this.labels=(0,t.dict)(),this.targets=[]}label(e,t){this.labels[e]=t}target(e,t){this.targets.push({at:e,target:t})}patch(e){let{targets:r,labels:n}=this
for(const{at:i,target:s}of r){let r=n[s]-i;(0,t.assert)(-1===e.getbyaddr(i),"Expected heap to contain a placeholder, but it did not"),e.setbyaddr(i,r)}}}function w(e,r,n,i,o){if(function(e){return e<f.Start}(o[0])){let[t,...n]=o
e.push(r,t,...n)}else switch(o[0]){case f.Label:return e.label(o[1])
case f.StartLabels:return e.startLabels()
case f.StopLabels:return e.stopLabels()
case p.Component:return function(e,r,n,[,i,o]){if((0,t.assert)(l(i),"Attempted to resolve a component with incorrect opcode"),i[0]===s.SexpOpcodes.GetLexicalSymbol){let{scopeValues:e,owner:s}=n,a=(0,t.expect)(e,"BUG: scopeValues must exist if template symbol is used")[i[1]]
...
case p.Modifier:return function(e,r,n,[,i,o]){(0,t.assert)(u(i),"Attempted to resolve a modifier with incorrect opcode")
let a=i[0]
...
case p.Helper:return function(e,r,n,[,i,o]){(0,t.assert)(c(i),"Attempted to resolve a helper with incorrect opcode")
let a=i[0]
if(a===s.SexpOpcodes.GetLexicalSymbol){let{scopeValues:e}=n,s=(0,t.expect)(e,"BUG: scopeValues must exist if template symbol is used")[i[1]]
o(r.helper(s))}else if(a===s.SexpOpcodes.GetStrictKeyword)o(h(i,e,n,r))
else{let{upvars:s,owner:a}=n,l=(0,t.unwrap)(s[i[1]]),u=e.lookupHelper(l,a)
o(r.helper(u,l))}}(n,r,i,o)
case p.ComponentOrHelper:return function(e,r,n,[,i,{ifComponent:o,ifHelper:a}]){(0,t.assert)(d(i),"Attempted to resolve a component or helper with incorrect opcode")
let l=i[0]
...
a((0,t.expect)(c,"BUG: helper must exist"))}else if(l===s.SexpOpcodes.GetStrictKeyword)a(h(i,e,n,r))
...
case p.OptionalComponentOrHelper:return function(e,r,n,[,i,{ifComponent:o,ifHelper:a,ifValue:l}]){(0,t.assert)(d(i),"Attempted to resolve an optional component or helper with incorrect opcode")
let u=i[0]
...
l(r.value(u))}else if(u===s.SexpOpcodes.GetStrictKeyword)a(h(i,e,n,r))
else{let{upvars:s,owner:l}=n,u=(0,t.unwrap)(s[i[1]]),c=e.lookupComponent(u,l)
if(null!==c)return void o(r.resolvedComponent(c,u))
let d=e.lookupHelper(u,l)
null!==d&&a(r.helper(d,u))}}(n,r,i,o)
case p.Local:{let e=o[1],r=(0,t.expect)(i.upvars,"BUG: attempted to resolve value but no upvars found")[e];(0,o[2])(r,i.moduleName)
break}case p.TemplateLocal:{let[,e,n]=o,s=(0,t.expect)(i.scopeValues,"BUG: Attempted to get a template local, but template does not have any")[e]
n(r.value(s))
break}default:throw new Error(`Unexpected high level opcode ${o[0]}`)}}class R{constructor(e,r,n){this.labelsStack=new t.Stack,this.encoder=new i.InstructionEncoderImpl([]),this.errors=[],this.handle=void 0,this.heap=e,this.meta=r,this.stdlib=n,this.handle=e.malloc()}error(e){this.encoder.encode(n.Op.Primitive,0),this.errors.push(e)}commit(e){let r=this.handle
...
case m.Block:return(0,t.encodeHandle)(e.value((n=r.value,i=this.meta,new pe(n[0],i,{parameters:n[1]||t.EMPTY_ARRAY}))))
...
return new k(n?(0,t.assign)({},n,{[e]:r}):{[e]:r})}get hasAny(){return null!==this.blocks}}const C=e.EMPTY_BLOCKS=new k(null)
function S(e){if(null===e)return C
let r=(0,t.dict)(),[n,i]=e
for(const[s,o]of(0,t.enumerate)(n))r[o]=(0,t.unwrap)(i[s])
return new k(r)}function T(e,t){P(e,t),e(n.Op.PrimitiveReference)}function P(e,r){let i=r
var s
"number"==typeof i&&(i=(0,t.isSmallInt)(i)?(0,t.encodeImmediate)(i):(s=i,(0,t.assert)(!(0,t.isSmallInt)(s),"Attempted to make a operand for an int that was not a small int, you should encode this as an immediate"),{type:m.NonSmallInt,value:s})),e(n.Op.Primitive,i)}function A(e,t,r,i){e(n.MachineOp.PushFrame),I(e,r,i,!1),e(n.Op.Helper,t),e(n.MachineOp.PopFrame),e(n.Op.Fetch,n.$v0)}function M(e,t,r,i){e(n.MachineOp.PushFrame),I(e,t,r,!1),e(n.Op.Dup,n.$fp,1),e(n.Op.DynamicHelper),i?(e(n.Op.Fetch,n.$v0),i(),e(n.MachineOp.PopFrame),e(n.Op.Pop,1)):(e(n.MachineOp.PopFrame),e(n.Op.Pop,1),e(n.Op.Fetch,n.$v0))}function x(e,t,r,i,s){e(n.MachineOp.PushFrame),I(e,i,s,!1),e(n.Op.CaptureArgs),F(e,r),e(n.Op.Curry,t,b()),e(n.MachineOp.PopFrame),e(n.Op.Fetch,n.$v0)}class j{constructor(){this.names={},this.funcs=[]}add(e,t){this.names[e]=this.funcs.push(t)-1}compile(e,r){let n=r[0],i=(0,t.unwrap)(this.names[n]),s=this.funcs[i];(0,t.assert)(!!s,`expected an implementation for ${r[0]}`),s(e,r)}}const D=new j
function N(e,t){if(void 0!==t&&0!==t.length)for(let r=0;r<t.length;r++)e(n.Op.GetProperty,t[r])}function F(e,t){Array.isArray(t)?D.compile(e,t):(P(e,t),e(n.Op.PrimitiveReference))}function I(e,r,i,s){if(null===r&&null===i)return void e(n.Op.PushEmptyArgs)
let o=L(e,r)<<4
s&&(o|=8)
let a=t.EMPTY_STRING_ARRAY
if(i){a=i[0]
let t=i[1]
for(let r=0;r<t.length;r++)F(e,t[r])}e(n.Op.PushArgs,a,t.EMPTY_STRING_ARRAY,o)}function L(e,t){if(null===t)return 0
for(let r=0;r<t.length;r++)F(e,t[r])
return t.length}function z(e){let[,t,,r]=e.block
...
return n?r:null}function U(e,t,r){I(e,r,null,!0),e(n.Op.GetBlock,t),e(n.Op.SpreadBlock),e(n.Op.CompileBlock),e(n.Op.InvokeYield),e(n.Op.PopScope),e(n.MachineOp.PopFrame)}function $(e,t){(function(e,t){null!==t?e(n.Op.PushSymbolTable,_({parameters:t})):P(e,null)})(e,t&&t[1]),e(n.Op.PushBlockScope),V(e,t)}function q(e,t){e(n.MachineOp.PushFrame),V(e,t),e(n.Op.CompileBlock),e(n.MachineOp.InvokeVirtual),e(n.MachineOp.PopFrame)}function H(e,t,r){let i=t[1],s=i.length,o=Math.min(r,s)
if(0!==o){if(e(n.MachineOp.PushFrame),o){e(n.Op.ChildScope)
for(let t=0;t<o;t++)e(n.Op.Dup,n.$fp,r-t),e(n.Op.SetVariable,i[t])}V(e,t),e(n.Op.CompileBlock),e(n.MachineOp.InvokeVirtual),o&&e(n.Op.PopScope),e(n.MachineOp.PopFrame)}else q(e,t)}function V(e,t){var r
null===t?P(e,null):e(n.Op.Constant,(r=t,{type:m.Block,value:r}))}function G(e,r,i){let s=[],o=0
i((function(e,t){s.push({match:e,callback:t,label:"CLAUSE"+o++})})),e(n.Op.Enter,1),r(),e(f.StartLabels)
for(let t of s.slice(0,-1))e(n.Op.JumpEq,g(t.label),t.match)
...
let i=t()
e(n.Op.Enter,i),r(),e(f.Label,"FINALLY"),e(n.Op.Exit),e(n.MachineOp.Return),e(f.Label,"ENDINITIAL"),e(n.MachineOp.PopFrame),e(f.StopLabels)}function Y(e,t,r,i){return W(e,t,(()=>{e(n.Op.JumpUnless,g("ELSE")),r(),e(n.MachineOp.Jump,g("FINALLY")),e(f.Label,"ELSE"),void 0!==i&&i()}))}D.add(s.SexpOpcodes.Concat,((e,[,t])=>{for(let r of t)F(e,r)
e(n.Op.Concat,t.length)})),D.add(s.SexpOpcodes.Call,((e,[,t,r,n])=>{c(t)?e(p.Helper,t,(t=>{A(e,t,r,n)})):(F(e,t),M(e,r,n))})),D.add(s.SexpOpcodes.Curry,((e,[,t,r,n,i])=>{x(e,r,t,n,i)})),D.add(s.SexpOpcodes.GetSymbol,((e,[,t,r])=>{e(n.Op.GetVariable,t),N(e,r)})),D.add(s.SexpOpcodes.GetLexicalSymbol,((e,[,t,r])=>{e(p.TemplateLocal,t,(t=>{e(n.Op.ConstantReference,t),N(e,r)}))})),D.add(s.SexpOpcodes.GetStrictKeyword,((e,t)=>{e(p.Local,t[1],(r=>{e(p.Helper,t,(t=>{A(e,t,null,null)}))}))})),D.add(s.SexpOpcodes.GetFreeAsHelperHead,((e,t)=>{e(p.Local,t[1],(r=>{e(p.Helper,t,(t=>{A(e,t,null,null)}))}))})),D.add(s.SexpOpcodes.Undefined,(e=>T(e,void 0))),D.add(s.SexpOpcodes.HasBlock,((e,[,t])=>{F(e,t),e(n.Op.HasBlock)})),D.add(s.SexpOpcodes.HasBlockParams,((e,[,t])=>{F(e,t),e(n.Op.SpreadBlock),e(n.Op.CompileBlock),e(n.Op.HasBlockParams)})),D.add(s.SexpOpcodes.IfInline,((e,[,t,r,i])=>{F(e,i),F(e,r),F(e,t),e(n.Op.IfInline)})),D.add(s.SexpOpcodes.Not,((e,[,t])=>{F(e,t),e(n.Op.Not)})),D.add(s.SexpOpcodes.GetDynamicVar,((e,[,t])=>{F(e,t),e(n.Op.GetDynamicVar)})),D.add(s.SexpOpcodes.Log,((e,[,t])=>{e(n.MachineOp.PushFrame),I(e,t,null,!1),e(n.Op.Log),e(n.MachineOp.PopFrame),e(n.Op.Fetch,n.$v0)}))
const K="&attrs"
function Q(e,r,i,s,a,l){let{compilable:u,capabilities:c,handle:d}=r,h=i?[i,[]]:null,p=Array.isArray(l)||null===l?S(l):l
...
if(d)return void X(e,{capabilities:r,elementBlock:s,positional:a,named:l,atNames:!0,blocks:u,layout:i})
e(n.Op.Fetch,n.$s0),e(n.Op.Dup,n.$sp,1),e(n.Op.Load,n.$s0),e(n.MachineOp.PushFrame)
let{symbols:h}=c,p=[],f=[],m=[],g=u.names
if(null!==s){let t=h.indexOf(K);-1!==t&&($(e,s),p.push(t))}for(const t of g){let r=h.indexOf(`&${t}`);-1!==r&&($(e,u.get(t)),p.push(r))}if((0,o.hasCapability)(r,n.InternalComponentCapabilities.createArgs)){let r=L(e,a)<<4
r|=8
let i=t.EMPTY_STRING_ARRAY
if(null!==l){i=l[0]
let r=l[1]
for(let n=0;n<r.length;n++){let s=h.indexOf((0,t.unwrap)(i[n]))
F(e,r[n]),f.push(s)}}e(n.Op.PushArgs,i,t.EMPTY_STRING_ARRAY,r),f.push(-1)}else if(null!==l){let r=l[0],n=l[1]
for(let i=0;i<n.length;i++){let s=(0,t.unwrap)(r[i]),o=h.indexOf(s);-1!==o&&(F(e,n[i]),f.push(o),m.push(s))}}e(n.Op.BeginComponentTransaction,n.$s0),(0,o.hasCapability)(r,n.InternalComponentCapabilities.dynamicScope)&&e(n.Op.PushDynamicScope);(0,o.hasCapability)(r,n.InternalComponentCapabilities.createInstance)&&e(n.Op.CreateComponent,0|u.has("default"),n.$s0)
...
return[e[0].map((e=>`@${e}`)),e[1]]}ae.add(s.SexpOpcodes.Comment,((e,t)=>e(n.Op.Comment,t[1]))),ae.add(s.SexpOpcodes.CloseElement,(e=>e(n.Op.CloseElement))),ae.add(s.SexpOpcodes.FlushElement,(e=>e(n.Op.FlushElement))),ae.add(s.SexpOpcodes.Modifier,((e,[,t,r,i])=>{u(t)?e(p.Modifier,t,(t=>{e(n.MachineOp.PushFrame),I(e,r,i,!1),e(n.Op.Modifier,t),e(n.MachineOp.PopFrame)})):(F(e,t),e(n.MachineOp.PushFrame),I(e,r,i,!1),e(n.Op.Dup,n.$fp,1),e(n.Op.DynamicModifier),e(n.MachineOp.PopFrame))})),ae.add(s.SexpOpcodes.StaticAttr,((e,[,t,r,i])=>{e(n.Op.StaticAttr,de(t),r,i??null)})),ae.add(s.SexpOpcodes.StaticComponentAttr,((e,[,t,r,i])=>{e(n.Op.StaticComponentAttr,de(t),r,i??null)})),ae.add(s.SexpOpcodes.DynamicAttr,((e,[,t,r,i])=>{F(e,r),e(n.Op.DynamicAttr,de(t),!1,i??null)})),ae.add(s.SexpOpcodes.TrustingDynamicAttr,((e,[,t,r,i])=>{F(e,r),e(n.Op.DynamicAttr,de(t),!0,i??null)})),ae.add(s.SexpOpcodes.ComponentAttr,((e,[,t,r,i])=>{F(e,r),e(n.Op.ComponentAttr,de(t),!1,i??null)})),ae.add(s.SexpOpcodes.TrustingComponentAttr,((e,[,t,r,i])=>{F(e,r),e(n.Op.ComponentAttr,de(t),!0,i??null)})),ae.add(s.SexpOpcodes.OpenElement,((e,[,t])=>{e(n.Op.OpenElement,ce(t))})),ae.add(s.SexpOpcodes.OpenElementWithSplat,((e,[,t])=>{e(n.Op.PutComponentOperations),e(n.Op.OpenElement,ce(t))})),ae.add(s.SexpOpcodes.Component,((e,[,t,r,n,i])=>{l(t)?e(p.Component,t,(t=>{Q(e,t,r,null,n,i)})):J(e,t,r,null,n,i,!0,!0)})),ae.add(s.SexpOpcodes.Yield,((e,[,t,r])=>U(e,t,r))),ae.add(s.SexpOpcodes.AttrSplat,((e,[,t])=>U(e,t,null))),ae.add(s.SexpOpcodes.Debugger,((e,[,t])=>e(n.Op.Debugger,{type:m.DebugSymbols,value:void 0},t))),ae.add(s.SexpOpcodes.Append,((e,[,t])=>{if(Array.isArray(t))if(d(t))e(p.OptionalComponentOrHelper,t,{ifComponent(t){Q(e,t,null,null,null,null)},ifHelper(t){e(n.MachineOp.PushFrame),A(e,t,null,null),e(n.MachineOp.InvokeStatic,y("cautious-non-dynamic-append")),e(n.MachineOp.PopFrame)},ifValue(t){e(n.MachineOp.PushFrame),e(n.Op.ConstantReference,t),e(n.MachineOp.InvokeStatic,y("cautious-non-dynamic-append")),e(n.MachineOp.PopFrame)}})
else if(t[0]===s.SexpOpcodes.Call){let[,r,i,s]=t
d(r)?e(p.ComponentOrHelper,r,{ifComponent(t){Q(e,t,null,i,he(s),null)},ifHelper(t){e(n.MachineOp.PushFrame),A(e,t,i,s),e(n.MachineOp.InvokeStatic,y("cautious-non-dynamic-append")),e(n.MachineOp.PopFrame)}}):G(e,(()=>{F(e,r),e(n.Op.DynamicContentType)}),(t=>{t(n.ContentType.Component,(()=>{e(n.Op.ResolveCurriedComponent),e(n.Op.PushDynamicComponentInstance),X(e,{capabilities:!0,elementBlock:null,positional:i,named:s,atNames:!1,blocks:S(null)})})),t(n.ContentType.Helper,(()=>{M(e,i,s,(()=>{e(n.MachineOp.InvokeStatic,y("cautious-non-dynamic-append"))}))}))}))}else e(n.MachineOp.PushFrame),F(e,t),e(n.MachineOp.InvokeStatic,y("cautious-append")),e(n.MachineOp.PopFrame)
else e(n.Op.Text,null==t?"":String(t))})),ae.add(s.SexpOpcodes.TrustingAppend,((e,[,t])=>{Array.isArray(t)?(e(n.MachineOp.PushFrame),F(e,t),e(n.MachineOp.InvokeStatic,y("trusting-append")),e(n.MachineOp.PopFrame)):e(n.Op.Text,null==t?"":String(t))})),ae.add(s.SexpOpcodes.Block,((e,[,t,r,n,i])=>{l(t)?e(p.Component,t,(t=>{Q(e,t,null,r,he(n),i)})):J(e,t,null,r,n,i,!1,!1)})),ae.add(s.SexpOpcodes.InElement,((e,[,t,r,i,s])=>{Y(e,(()=>(F(e,r),void 0===s?T(e,void 0):F(e,s),F(e,i),e(n.Op.Dup,n.$sp,0),4)),(()=>{e(n.Op.PushRemoteElement),q(e,t),e(n.Op.PopRemoteElement)}))})),ae.add(s.SexpOpcodes.If,((e,[,t,r,i])=>Y(e,(()=>(F(e,t),e(n.Op.ToBoolean),1)),(()=>{q(e,r)}),i?()=>{q(e,i)}:void 0))),ae.add(s.SexpOpcodes.Each,((e,[,t,r,i,s])=>W(e,(()=>(r?F(e,r):T(e,null),F(e,t),2)),(()=>{e(n.Op.EnterList,g("BODY"),g("ELSE")),e(n.MachineOp.PushFrame),e(n.Op.Dup,n.$fp,1),e(n.MachineOp.ReturnTo,g("ITER")),e(f.Label,"ITER"),e(n.Op.Iterate,g("BREAK")),e(f.Label,"BODY"),H(e,i,2),e(n.Op.Pop,2),e(n.MachineOp.Jump,g("FINALLY")),e(f.Label,"BREAK"),e(n.MachineOp.PopFrame),e(n.Op.ExitList),e(n.MachineOp.Jump,g("FINALLY")),e(f.Label,"ELSE"),s&&q(e,s)})))),ae.add(s.SexpOpcodes.Let,((e,[,t,r])=>{H(e,r,L(e,t))})),ae.add(s.SexpOpcodes.WithDynamicVars,((e,[,t,r])=>{if(t){let[i,s]=t
L(e,s),function(e,t,r){e(n.Op.PushDynamicScope),e(n.Op.BindDynamicScope,t),r(),e(n.Op.PopDynamicScope)}(e,i,(()=>{q(e,r)}))}else q(e,r)})),ae.add(s.SexpOpcodes.InvokeComponent,((e,[,t,r,n,i])=>{l(t)?e(p.Component,t,(t=>{Q(e,t,null,r,he(n),i)})):J(e,t,null,r,n,i,!1,!1)}))
class pe{constructor(e,t,r,n="plain block"){this.compiled=null,this.statements=e,this.meta=t,this.symbolTable=r,this.moduleName=n}compile(e){return function(e,t){if(null!==e.compiled)return e.compiled
e.compiled=-1
let{statements:r,meta:n}=e,i=me(r,n,t)
return e.compiled=i,i}(this,e)}}function fe(e,t){let[r,n,i]=e.block
return new pe(r,z(e),{symbols:n,hasEval:i},t)}function me(e,t,r){let n=ae,i=oe(r,t),{encoder:s,program:{constants:o,resolver:a}}=i
function l(...e){w(s,o,a,t,e)}for(const u of e)n.compile(l,u)
...
n=n.slice()
let s=n.indexOf(K)
this.attrsBlockNumber=-1===s?n.push(K):s+1,this.symbolTable={hasEval:i,symbols:n}}compile(e){if(null!==this.compiled)return this.compiled
let t=z(this.layout),r=oe(e,t),{encoder:n,program:{constants:i,resolver:s}}=r
Z((function(...e){w(n,i,s,t,e)}),this.layout,this.attrsBlockNumber)
let o=r.encoder.commit(t.size)
return"number"!=typeof o||(this.compiled=o),o}}e.WrappedBuilder=ge
let be=0,ye=e.templateCacheCounters={cacheHit:0,cacheMiss:0}
class _e{constructor(e){this.result="ok",this.layout=null,this.wrappedLayout=null,this.parsedLayout=e}get moduleName(){return this.parsedLayout.moduleName}get id(){return this.parsedLayout.id}get referrer(){return{moduleName:this.parsedLayout.moduleName,owner:this.parsedLayout.owner}}asLayout(){return this.layout?this.layout:this.layout=fe((0,t.assign)({},this.parsedLayout),this.moduleName)}asWrappedLayout(){return this.wrappedLayout?this.wrappedLayout:this.wrappedLayout=new ge((0,t.assign)({},this.parsedLayout),this.moduleName)}}})),e("@glimmer/owner",["exports"],(function(e){"use strict"
...
return p((()=>((0,n.consumeTag)(r),t)),(e=>{t!==e&&(t=e,(0,n.dirtyTag)(r))}))},e.createIteratorRef=function(e,n){return p((()=>{let i=m(e),s=function(e){switch(e){case"@key":return E(_)
...
return t.set(i,s+1),0===s?i:function(e,t){let r=R.get(e)
void 0===r&&(r=[],R.set(e,r))
let n=r[t]
return void 0===n&&(n={value:e,count:t},r[t]=n),n}(i,s)}}class k{constructor(e,t){this.inner=e,this.keyFor=t}isEmpty(){return this.inner.isEmpty()}next(){let e=this.inner.next()
...
if((0,a.hasDestroyable)(o)){let e=o.getDestroyable(h);(0,s.associateDestroyableChild)(u,e)}return u},Object.defineProperty(e,"isDestroyed",{enumerable:!0,get:function(){return s.isDestroyed}}),Object.defineProperty(e,"isDestroying",{enumerable:!0,get:function(){return s.isDestroying}}),e.isSerializationFirstNode=function(e){return e.nodeValue===Or},e.isWhitespace=function(e){return zt.test(e)},e.normalizeProperty=P,e.on=void 0,Object.defineProperty(e,"registerDestructor",{enumerable:!0,get:function(){return s.registerDestructor}}),e.rehydrationBuilder=function(e,t){return Rr.forInitialRender(e,t)},e.reifyArgs=function(e){return{named:ut(e.named),positional:ct(e.positional)}},e.reifyNamed=ut,e.reifyPositional=ct,e.renderComponent=function(e,t,i,s,o,a={},l=new d){let u=br.empty(e,{treeBuilder:t,handle:i.stdlib.main,dynamicScope:l,owner:s},i)
...
return e.stack.push(e[_]),e.stack.push(h),e.stack.push(u),new vr(e)}(u,i,s,o,function(e){const t=(0,r.createConstRef)(e,"args")
return Object.keys(e).reduce(((e,n)=>(e[n]=(0,r.childRefFor)(t,n),e)),{})}(a))},e.renderMain=function(e,t,r,i,s,o,a=new d){let l=(0,n.unwrapHandle)(o.compile(t)),u=o.symbolTable.symbols.length,c=br.initial(e,t,{self:i,dynamicScope:a,treeBuilder:s,handle:l,numSymbols:u,owner:r})
return new vr(c)},e.renderSync=function(e,t){let r
return Kt(e,(()=>r=t.sync())),r},e.resetDebuggerCallback=function(){kt=Et},e.runtimeContext=function(e,t,r,n){return{env:new Yt(e,t),program:new u.RuntimeProgramImpl(r.constants,r.heap),resolver:n}},e.setDebuggerCallback=function(e){kt=e},e.templateOnlyComponent=function(e,t){return new At(e,t)}
...
!e.alwaysRevalidate&&(0,l.validateTag)(t,i)&&((0,l.consumeTag)(t),e.goto((0,n.expect)(r,"VM BUG: Target must be set before attempting to jump")))}didModify(e){this.tag=e,this.lastRevision=(0,l.valueForTag)(this.tag),(0,l.consumeTag)(e)}}class Re{constructor(e){this.debugLabel=e}evaluate(){(0,l.beginTrackFrame)(this.debugLabel)}}class Ee{constructor(e){this.target=e}evaluate(){let e=(0,l.endTrackFrame)()
...
e.elements().openElement(n)})),ae.add(i.Op.PushRemoteElement,(e=>{let n=(0,t.check)(e.stack.pop(),Ie),i=(0,t.check)(e.stack.pop(),Ie),o=(0,t.check)(e.stack.pop(),Ie),a=(0,t.check)((0,r.valueForRef)(n),t.CheckElement),l=(0,t.check)((0,r.valueForRef)(i),(0,t.CheckMaybe)((0,t.CheckOption)(t.CheckNode))),u=(0,r.valueForRef)(o);(0,r.isConstRef)(n)||e.updateWith(new ve(n)),void 0===l||(0,r.isConstRef)(i)||e.updateWith(new ve(i))
...
e.env.debugRenderTree.create(c,{type:"keyword",name:"in-element",args:t,instance:null}),(0,s.registerDestructor)(c,(()=>{e.env.debugRenderTree?.willDestroy(c)}))}})),ae.add(i.Op.PopRemoteElement,(e=>{let t=e.elements().popRemoteElement()
void 0!==e.env.debugRenderTree&&e.env.debugRenderTree.didRender(t,t)})),ae.add(i.Op.FlushElement,(e=>{let r=(0,t.check)(e.fetchValue(i.$t0),Fe),n=null
...
let s=e.getOwner(),o=(0,t.check)(e.stack.pop(),ze),a=e[y].getValue(r),{manager:u}=a,{constructing:c}=e.elements(),d=o.capture(),h=u.create(s,(0,n.expect)(c,"BUG: ElementModifier could not find the element it applies to"),a.state,d),p={manager:u,state:h,definition:a};(0,n.expect)((0,t.check)(e.fetchValue(i.$t0),Fe),"BUG: ElementModifier could not find operations to append to").addModifier(e,p,d)
let f=u.getTag(h)
return null!==f?((0,l.consumeTag)(f),e.updateWith(new ke(f,p))):void 0})),ae.add(i.Op.DynamicModifier,(e=>{if(!1===e.env.isInteractive)return
let{stack:s}=e,o=(0,t.check)(s.pop(),Ie),u=(0,t.check)(s.pop(),ze).capture(),{positional:c,named:d}=u,{constructing:h}=e.elements(),p=e.getOwner(),f=(0,r.createComputeRef)((()=>{let e,t,s=(0,r.valueForRef)(o)
if(!(0,n.isObject)(s))return
if(me(s,i.CurriedTypes.Modifier)){let{definition:r,owner:n,positional:i,named:o}=be(s)
t=r,e=n,void 0!==i&&(u.positional=i.concat(c)),void 0!==o&&(u.named=Object.assign({},...o,d))}else t=s,e=p
let l=(0,a.getInternalModifierManager)(t,!0)
if(null===l)throw new Error("BUG: modifier manager expected")
let f={resolvedName:null,manager:l,state:t},m=l.create(e,(0,n.expect)(h,"BUG: ElementModifier could not find the element it applies to"),f.state,u)
return{manager:l,state:m,definition:f}})),m=(0,r.valueForRef)(f),g=null
if(void 0!==m){(0,n.expect)((0,t.check)(e.fetchValue(i.$t0),Fe),"BUG: ElementModifier could not find operations to append to").addModifier(e,m,u),g=m.manager.getTag(m.state),null!==g&&(0,l.consumeTag)(g)}return!(0,r.isConstRef)(o)||g?e.updateWith(new Ce(g,m,f)):void 0}))
...
"class"===e&&this.classes.push(t),this.attributes[e]=n}addModifier(e,t,r){if(this.modifiers.push(t),void 0!==e.env.debugRenderTree){const{manager:i,definition:o,state:a}=t
if(null===a||"object"!=typeof a&&"function"!=typeof a)return
let{element:l,constructing:u}=e.elements(),c=i.getDebugName(o.state),d=i.getDebugInstance(a);(0,n.assert)(u,"Expected a constructing element in addModifier")
let h=new O(l,u,u)
e.env.debugRenderTree.create(a,{type:"modifier",name:c,args:r,instance:d}),e.env.debugRenderTree.didRender(a,h),e.associateDestroyable(a),e.updateWith(new De(a)),e.updateWith(new Ne(a,h)),(0,s.registerDestructor)(a,(()=>{e.env.debugRenderTree?.willDestroy(a)}))}}flush(e){let t,r=this.attributes
...
if(void 0!==e.env.debugRenderTree)if(_e(s)){s.getDebugCustomRenderTree(n.definition.state,o,bt).reverse().forEach((t=>{let{bucket:r}=t
...
function ht(e){return null!==e&&"object"==typeof e&&e[dt]}function pt(e){return{[dt]:!0,error:e}}function ft(e){return{named:function(e){let t=(0,n.dict)()
for(const[n,s]of Object.entries(e))try{t[n]=(0,r.valueForRef)(s)}catch(i){t[n]=pt(i)}return t}(e.named),positional:function(e){return e.map((e=>{try{return(0,r.valueForRef)(e)}catch(t){return pt(t)}}))}(e.positional)}}const mt=e.EMPTY_NAMED=Object.freeze(Object.create(null)),gt=e.EMPTY_POSITIONAL=tt,bt=e.EMPTY_ARGS=lt(mt,gt)
function yt(e){return"string"==typeof e?e:"function"!=typeof e.toString?"":String(e)}function _t(e,t){let r,i=(0,a.getInternalHelperManager)(e,!0)
...
if(me(e,i.CurriedTypes.Helper)){let{definition:t,owner:r,positional:i,named:a}=be(e),c=_t(t,l)
void 0!==a&&(u.named=(0,n.assign)({},...a,u.named)),void 0!==i&&(u.positional=i.concat(u.positional)),o=c(u,r),(0,s.associateDestroyableChild)(d,o)}else if((0,n.isObject)(e)){let t=_t(e,l)
...
i&&!vt(i)?n.push(r.TRUE_REFERENCE):n.push(r.FALSE_REFERENCE)})),ae.add(i.Op.HasBlockParams,(e=>{let n=e.stack.pop(),i=e.stack.pop();(0,t.check)(n,(0,t.CheckMaybe)((0,t.CheckOr)(t.CheckHandle,Qe))),(0,t.check)(i,(0,t.CheckMaybe)(qe))
...
null!=n&&e.push(yt(n))}return e.length>0?e.join(""):null}))))})),ae.add(i.Op.IfInline,(e=>{let n=(0,t.check)(e.stack.pop(),Ie),i=(0,t.check)(e.stack.pop(),Ie),s=(0,t.check)(e.stack.pop(),Ie)
...
if(t!==n&&(e=k(t)?"":T(t)?t:String(t),e!==n)){this.node.nodeValue=this.lastValue=e}}}function wt(e){return function(e){return T(e)||k(e)||"boolean"==typeof e||"number"==typeof e}(e)?i.ContentType.String:me(e,i.CurriedType.Component)||(0,a.hasInternalComponentManager)(e)?i.ContentType.Component:me(e,i.CurriedType.Helper)||(0,a.hasInternalHelperManager)(e)?i.ContentType.Helper:C(e)?i.ContentType.SafeString:function(e){return S(e)&&11===e.nodeType}(e)?i.ContentType.Fragment:S(e)?i.ContentType.Node:i.ContentType.String}function Rt(e){return(0,n.isObject)(e)?me(e,i.CurriedType.Component)||(0,a.hasInternalComponentManager)(e)?i.ContentType.Component:i.ContentType.Helper:i.ContentType.String}function Et(e,t){console.info("Use `context`, and `get(<path>)` to debug this template."),t("this")}ae.add(i.Op.ContentType,(e=>{let n=(0,t.check)(e.stack.peek(),Ie)
e.stack.push(wt((0,r.valueForRef)(n))),(0,r.isConstRef)(n)||e.updateWith(new Oe(n,wt))})),ae.add(i.Op.DynamicContentType,(e=>{let n=(0,t.check)(e.stack.peek(),Ie)
e.stack.push(Rt((0,r.valueForRef)(n))),(0,r.isConstRef)(n)||e.updateWith(new Oe(n,Rt))})),ae.add(i.Op.AppendHTML,(e=>{let n=(0,t.check)(e.stack.pop(),Ie),i=(0,r.valueForRef)(n),s=k(i)?"":String(i)
e.elements().appendDynamicHTML(s)})),ae.add(i.Op.AppendSafeHTML,(e=>{let n=(0,t.check)(e.stack.pop(),Ie),i=(0,t.check)((0,r.valueForRef)(n),t.CheckSafeString).toHTML(),s=k(i)?"":(0,t.check)(i,t.CheckString)
e.elements().appendDynamicHTML(s)})),ae.add(i.Op.AppendText,(e=>{let n=(0,t.check)(e.stack.pop(),Ie),i=(0,r.valueForRef)(n),s=k(i)?"":String(i),o=e.elements().appendDynamicText(s);(0,r.isConstRef)(n)||e.updateWith(new Ot(o,n,s))})),ae.add(i.Op.AppendDocumentFragment,(e=>{let n=(0,t.check)(e.stack.pop(),Ie),i=(0,t.check)((0,r.valueForRef)(n),t.CheckDocumentFragment)
...
kt((0,r.valueForRef)(e.getSelf()),(e=>(0,r.valueForRef)(a.get(e))))})),ae.add(i.Op.EnterList,((e,{op1:n,op2:i})=>{let s=e.stack,o=(0,t.check)(s.pop(),Ie),a=(0,t.check)(s.pop(),Ie),l=(0,r.valueForRef)(a),u=null===l?"@identity":String(l),c=(0,r.createIteratorRef)(o,u),d=(0,r.valueForRef)(c)
...
class Tt{getCapabilities(){return St}getDebugName({name:e}){return e}getSelf(){return r.NULL_REFERENCE}getDestroyable(){return null}}e.TemplateOnlyComponentManager=Tt
const Pt=e.TEMPLATE_ONLY_COMPONENT_MANAGER=new Tt
...
const Mt={foreignObject:1,desc:1,title:1},xt=Object.create(null)
...
if(t?(r=t.namespaceURI===n.NS_SVG||"svg"===e,i=!!Mt[t.tagName]):(r="svg"===e,i=!1),r&&!i){if(xt[e])throw new Error(`Cannot create a ${e} inside an SVG context`)
...
return new O(e,o,s)}createTextNode(e){return this.document.createTextNode(e)}createComment(e){return this.document.createComment(e)}}function Dt(e,t,r){if(!e)return t
...
t.insertBefore(o,r),s=o,o=e}return new O(t,i,s)}(s,e,i)}(e,i,s,t)}}}function Nt(e,t){return e&&function(e){const t=e.createElement("div")
...
return n&&e.removeChild(this.uselessComment),s}}:t}const Ft="undefined"==typeof document?null:(0,n.castToSimple)(document)
let It=class extends jt{createElementNS(e,t){return this.document.createElementNS(e,t)}setAttribute(e,t,r,n=null){n?e.setAttributeNS(n,t,r):e.setAttribute(t,r)}}
It=Nt(Ft,It),It=Dt(Ft,It,n.NS_SVG)
const Lt=e.DOMTreeConstruction=It;["b","big","blockquote","body","br","center","code","dd","div","dl","dt","em","embed","h1","h2","h3","h4","h5","h6","head","hr","i","img","li","listing","main","meta","nobr","ol","p","pre","ruby","s","small","span","strong","strike","sub","sup","table","tt","u","ul","var"].forEach((e=>xt[e]=1))
...
class Ut extends jt{constructor(e){super(e),this.namespace=void 0,this.document=e,this.namespace=null}setAttribute(e,t,r){e.setAttribute(t,r)}removeAttribute(e,t){e.removeAttribute(t)}insertAfter(e,t,r){this.insertBefore(e,t,r.nextSibling)}}e.IDOMChanges=Ut
let $t=Ut
$t=Nt(Bt,$t),$t=Dt(Bt,$t,n.NS_SVG)
e.DOMChanges=$t
let qt=0
class Ht{constructor(e){this.id=qt++,this.value=void 0,this.value=e}get(){return this.value}release(){this.value=null}toString(){let e=`Ref ${this.id}`
...
return{id:e,type:n,name:i,args:ft(s),instance:o,template:l,bounds:u,children:c}}captureTemplate({template:e}){return e||null}captureBounds(e){let t=(0,n.expect)(e.bounds,"BUG: missing bounds")
...
return(0,r.updateRef)(n,e)}return i.call(Xt,...s,...t)}),null,"fn")}))
...
if((0,n.isDict)(s))return(0,o.setPath)(s,String((0,r.valueForRef)(i)),e)}),"get")})),e.hash=Qt((({named:e})=>{let t=(0,r.createComputeRef)((()=>ut(e)),null,"hash"),n=new Map
...
class rr{constructor(e,t){this.tag=(0,l.createUpdatableTag)(),this.element=void 0,this.args=void 0,this.listener=null,this.element=e,this.args=t,(0,s.registerDestructor)(this,(()=>{let{element:e,listener:t}=this
if(t){let{eventName:r,callback:n,options:i}=t
sr(e,r,n,i)}}))}updateListener(){let{element:e,args:i,listener:s}=this;(0,n.assert)(i.positional[0],"You must pass a valid DOM event name as the first argument to the `on` modifier")
let o=(0,t.check)((0,r.valueForRef)(i.positional[0]),t.CheckString,(()=>"You must pass a valid DOM event name as the first argument to the `on` modifier"));(0,n.assert)(i.positional[1],"You must pass a function as the second argument to the `on` modifier")
...
void 0!==e?e.evaluate(this):r.pop()}}get frame(){return(0,n.expect)(this.frameStack.current,"bug: expected a frame")}goto(e){this.frame.goto(e)}try(e,t){this.frameStack.push(new pr(e,t))}throw(){this.frame.handleException(),this.frameStack.pop()}}e.UpdatingVM=ar
class lr{constructor(e,t){this.state=e,this.resumeCallback=t}resume(e,t){return this.resumeCallback(e,this.state,t)}}class ur{constructor(e,t,r,n){this.children=void 0,this.bounds=void 0,this.state=e,this.runtime=t,this.children=n,this.bounds=r}parentElement(){return this.bounds.parentElement()}firstNode(){return this.bounds.firstNode()}lastNode(){return this.bounds.lastNode()}evaluate(e){e.try(this.children,null)}}class cr extends ur{constructor(...e){super(...e),this.type="try"}evaluate(e){e.try(this.children,this)}handleException(){let{state:e,bounds:t,runtime:r}=this;(0,s.destroyChildren)(this)
let n=re.resume(r.env,t),i=e.resume(r,n),o=[],a=this.children=[],l=i.execute((e=>{e.pushUpdating(o),e.updateWith(this),e.pushUpdating(a)}));(0,s.associateDestroyableChild)(this,l.drop)}}class dr extends cr{constructor(e,t,r,n,i,s){super(e,t,r,[]),this.retained=!1,this.index=-1,this.key=n,this.memo=i,this.value=s}updateReferences(e){this.retained=!0,(0,r.updateRef)(this.value,e.value),(0,r.updateRef)(this.memo,e.memo)}shouldRemove(){return!this.retained}reset(){this.retained=!1}}class hr extends ur{constructor(e,t,n,i,s){super(e,t,n,i),this.type="list-block",this.opcodeMap=new Map,this.marker=null,this.lastIterator=void 0,this.iterableRef=s,this.lastIterator=(0,r.valueForRef)(s)}initializeChild(e){e.index=this.children.length-1,this.opcodeMap.set(e.key,e)}evaluate(e){let t=(0,r.valueForRef)(this.iterableRef)
...
let n=t.enterItem(e)
n.index=a.length,a.push(n),r.set(l,n),(0,s.associateDestroyableChild)(this,n)}))}moveItem(e,t,n){let i,s,{children:o}=this;(0,r.updateRef)(e.memo,t.memo),(0,r.updateRef)(e.value,t.value),e.retained=!0,void 0===n?w(e,this.marker):(i=e.lastNode().nextSibling,s=n.firstNode(),i!==s&&w(e,s)),e.index=o.length,o.push(e)}deleteItem(e){(0,s.destroy)(e),R(e),this.opcodeMap.delete(e.key)}}class pr{constructor(e,t){this.current=0,this.ops=e,this.exceptionHandler=t}goto(e){this.current=e}nextStatement(){return this.ops[this.current++]}handleException(){this.exceptionHandler&&this.exceptionHandler.handleException()}}class fr{constructor(e,t,r,n){this.env=e,this.updating=t,this.bounds=r,this.drop=n,(0,s.associateDestroyableChild)(this,n),(0,s.registerDestructor)(this,(()=>R(this.bounds)))}rerender({alwaysRevalidate:e=!1}={alwaysRevalidate:!1}){let{env:t,updating:r}=this
...
return this.stack.slice(r,t)}reset(){this.stack.length=0}toArray(){return this.stack.slice(this[g][i.$fp],this[g][i.$sp]+1)}}class gr{constructor(){this.scope=new n.Stack,this.dynamicScope=new n.Stack,this.updating=new n.Stack,this.cache=new n.Stack,this.list=new n.Stack}}class br{get stack(){return this[p].stack}get pc(){return this[p].fetchRegister(i.$pc)}fetch(e){let t=this.fetchValue(e)
...
case i.$t1:this.t1=t
break
case i.$v0:this.v0=t}}pushFrame(){this[p].pushFrame()}popFrame(){this[p].popFrame()}goto(e){this[p].goto(e)}call(e){this[p].call(e)}returnTo(e){this[p].returnTo(e)}return(){this[p].return()}constructor(e,{pc:t,scope:r,dynamicScope:s,stack:o},a,l){this[m]=new gr,this[b]=void 0,this.destructor=void 0,this[f]=new n.Stack,this[y]=void 0,this[_]=void 0,this[p]=void 0,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.v0=null,this.resume=void 0,this.runtime=e,this.elementStack=a,this.context=l,this.resume=_r(l)
let u=mr.restore(o);(0,n.assert)("number"==typeof t,"pc is a number"),u[g][i.$pc]=t,u[g][i.$sp]=o.length-1,u[g][i.$fp]=-1,this[b]=this.program.heap,this[y]=this.program.constants,this.elementStack=a,this[m].scope.push(r),this[m].dynamicScope.push(s),this[_]=new et,this[p]=new or(u,this[b],e.program,{debugBefore:e=>ae.debugBefore(this,e),debugAfter:e=>{ae.debugAfter(this,e)}},u[g]),this.destructor={},this[f].push(this.destructor)}static initial(e,t,{handle:r,self:n,dynamicScope:i,treeBuilder:s,numSymbols:o,owner:a}){let l=h.root(n,o,a),u=yr(e.program.heap.getaddr(r),l,i),c=_r(t)(e,u,s)
return c.pushUpdating(),c}static empty(e,{handle:t,treeBuilder:n,dynamicScope:i,owner:s},o){let a=_r(o)(e,yr(e.program.heap.getaddr(t),h.root(r.UNDEFINED_REFERENCE,0,s),i),n)
return a.pushUpdating(),a}compile(e){return(0,n.unwrapHandle)(e.compile(this.context))}get program(){return this.runtime.program}get env(){return this.runtime.env}captureState(e,t=this[p].fetchRegister(i.$pc)){return{pc:t,scope:this.scope(),dynamicScope:this.dynamicScope(),stack:this.stack.capture(e)}}capture(e,t=this[p].fetchRegister(i.$pc)){return new lr(this.captureState(e,t),this.resume)}beginCacheGroup(e){let t=this.updating(),r=new we
t.push(r),t.push(new Re(e)),this[m].cache.push(r),(0,l.beginTrackFrame)(e)}commitCacheGroup(){let e=this.updating(),t=(0,n.expect)(this[m].cache.pop(),"VM BUG: Expected a cache group"),r=(0,l.endTrackFrame)()
...
i.push(s),i.push(o)
let a=this.capture(2),l=this.elements().pushUpdatableBlock(),u=new dr(a,this.runtime,l,e,o,s)
return this.didEnter(u),u}registerItem(e){this.listBlock().initializeChild(e)}enterList(e,t){let r=[],n=this[p].target(t),i=this.capture(0,n),s=this.elements().pushBlockList(r),o=new hr(i,this.runtime,s,r,e)
...
return null!==n?(this[p].evaluateOuter(n,this),e={done:!1,value:null}):(this.stack.reset(),e={done:!0,value:new fr(t,this.popUpdating(),r.popBlock(),this.destructor)}),e}bindDynamicScope(e){let t=this.dynamicScope()
for(const r of(0,n.reverse)(e))t.set(r,this.stack.pop())}}function yr(e,t,r){return{pc:e,scope:t,dynamicScope:r,stack:[]}}function _r(e){return(t,r,n)=>new br(t,r,n,e)}e.LowLevelVM=br
class vr{constructor(e){this.vm=e}next(){return this.vm.next()}sync(){return this.vm.execute()}}const Or=e.SERIALIZATION_FIRST_NODE_STRING="%+b:0%"
class wr extends v{constructor(e,t,r){super(e,t),this.candidate=null,this.openBlockDepth=void 0,this.injectedOmittedNode=!1,this.startingBlockDepth=r,this.openBlockDepth=r-1}}class Rr extends re{constructor(e,t,r){if(super(e,t,r),this.unmatchedAttributes=null,this.blockDepth=0,this.startingBlockOffset=void 0,r)throw new Error("Rehydration with nextSibling not supported")
...
let r=i.nextSibling
for(;null!==r&&(!kr(r)||Cr(r)!==s);)r=r.nextSibling;(0,n.assert)(r,"Must have closing comment for starting block comment")
...
r=null}const s=new wr(e,null,this.blockDepth)
...
this.candidate=t&&t.nextSibling}return e}}function Er(e){return e.nodeType===n.COMMENT_NODE&&0===e.nodeValue.lastIndexOf("%+b:",0)}function kr(e){return e.nodeType===n.COMMENT_NODE&&0===e.nodeValue.lastIndexOf("%-b:",0)}function Cr(e){return parseInt(e.nodeValue.slice(4),10)}function Sr(e,t){return Cr(e)-t}function Tr(e){return 1===e.nodeType}function Pr(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function Ar(e){return 8===e.nodeType&&"% %"===e.nodeValue}function Mr(e,t){for(const r of e)if(r.name===t)return r}e.RehydrateBuilder=Rr})),e("@glimmer/tracking/index",["exports","@ember/-internals/metal"],(function(e,t){"use strict"
...
return E(e,t)},e.castToSimple=function(e){return w(e)||R(e),e},e.checkNode=E,e.clearElement=function(e){let t=e.firstChild
...
t[e]=1
for(let r in t)if(r===e)return r
return e},e.isDict=function(e){return null!=e},e.isElement=function(e){return e?.nodeType===h&&e instanceof Element},e.isEmptyArray=function(e){return e===t},e.isErrHandle=function(e){return"number"==typeof e},e.isHandle=function(e){return e>=0},e.isNonPrimitiveHandle=function(e){return e>f.ENCODED_UNDEFINED_HANDLE},e.isObject=function(e){return"function"==typeof e||"object"==typeof e&&null!==e},e.isOkHandle=function(e){return"number"==typeof e},e.isPresent=o,e.isPresentArray=a,e.isSerializationFirstNode=function(e){return e.nodeValue===O},e.isSimpleElement=R,e.isSmallInt=function(e){return e%1==0&&e<=f.MAX_INT&&e>=f.MIN_INT},e.keys=function(e){return Object.keys(e)},e.logStep=void 0,e.mapPresentArray=function(e,t){if(null===e)return null
let r=[]
...
function w(e){return e.nodeType===p}function R(e){return e?.nodeType===h}function E(e,t){let r=!1
...
let w=g(),R=g(),E=g()
c(w),f(w),c(w),m(w,O([R,E])),c(w),f(R),c(w),f(E),c(w),m(w,E),c(w),f(E),c(w)
const k=new WeakMap
function C(e,t,r){let n=void 0===r?k.get(e):r
if(void 0===n)return
let i=n.get(t)
void 0!==i&&f(i,!0)}function S(e){let t=k.get(e)
return void 0===t&&(t=new Map,k.set(e,t)),t}function T(e,t,r){let n=void 0===r?S(e):r,i=n.get(t)
...
return 2===arguments.length?(t=arguments[0],i=arguments[1],e=null):([e,t,n]=b(...arguments),void 0===n?i=0:(i=n.pop(),o(i)||(r=!0===i,i=n.pop()))),i=parseInt(i,10),[e,t,n,i,r]}let _=0,v=0,O=0,w=0,R=0,E=0,k=0,C=0,S=0,T=0,P=0,A=0,M=0,x=0,j=0,D=0,N=0,F=0,I=0,L=0,z=0
...
let[e,t,r]=b(...arguments)
return this._join(e,t,r)}defer(e,t,r,...n){return k++,this.schedule(e,t,r,...n)}schedule(e,...t){C++
...
let w=new WeakMap
function R(e,t={},r={includeAttributes:!1,localizeMapUpdates:!1}){const n=new WeakMap
...
let t=E(e,u)
return n.set(d,e),r.localizeMapUpdates||w.set(d,t),t}const h=r.localizeMapUpdates?n:w
let p={find(t,r){let n,i=[]
3===t.length&&(i=e.map((e=>h.get(e))))
for(let s=0;e.length>s;s++)if(n=h.get(e[s]),t.call(r,n,s,i))return n},get name(){return o},get paramNames(){return l},get metadata(){return k(i.route)},get parent(){let t=e[s-1]
...
return r.includeAttributes&&(p=E(p,u)),n.set(i,p),r.localizeMapUpdates||w.set(i,p),p}))}function E(e,t){let r={get attributes(){return t}}
...
if(null===r)return r
let n=R(r.routeInfos,r.queryParams,{includeAttributes:!1,localizeMapUpdates:!0})
...
return i.then((()=>{let e=R(n.routeInfos,i[y],{includeAttributes:!0,localizeMapUpdates:!1})
...
this.fromInfos(e,r),this.toInfos(e,t.routeInfos),this._lastQueryParams=t.queryParams}fromInfos(e,t){if(void 0!==e&&t.length>0){let r=R(t,Object.assign({},this._lastQueryParams),{includeAttributes:!0,localizeMapUpdates:!1})
e.from=r[r.length-1]||null}}toInfos(e,t,r=!1){if(void 0!==e&&t.length>0){let n=R(t,Object.assign({},e[y]),{includeAttributes:r,localizeMapUpdates:!1})
...
i._state===c&&(this._abortOnReject&&e===h?b(i,r):(this._setResultAt(e,t,r,n),this._checkFullfillment()))}_setResultAt(e,t,r,n){this._remaining--,this._result[t]=r}_willSettleAt(e,t,r){y(e,void 0,(e=>this._settledAt(d,t,e,r)),(e=>this._settledAt(h,t,e,r)))}}function R(e,t,r){this._remaining--,this._result[t]=e===d?{state:"fulfilled",value:r}:{state:"rejected",reason:r}}const E="rsvp_"+Date.now()+"-"
let k=0
let C=class e{constructor(t,r){this._id=k++,this._label=r,this._state=void 0,this._result=void 0,this._subscribers=[],i.instrument&&a("created",this),u!==t&&("function"!=typeof t&&function(){throw new TypeError("You must pass a resolver function as the first argument to the promise constructor")}(),this instanceof e?function(e,t){let r=!1
...
return b(r,e),r},C.prototype._guidKey=E,C.prototype.then=O
var S=e.Promise=C
...
return t.promise=new S(((e,r)=>{t.resolve=e,t.reject=r}),e),t}I.prototype._setResultAt=R
...
s("instrument",!0)
for(let t in e)e.hasOwnProperty(t)&&le(t,e[t])}e.default={asap:Q,cast:oe,Promise:S,EventTarget:n,all:M,allSettled:j,race:D,hash:F,hashSettled:L,rethrow:z,defer:B,denodeify:P,configure:s,on:le,off:ue,resolve:q,reject:H,map:$,async:ae,filter:W}})),"object"==typeof module&&"function"==typeof module.require&&(module.exports=t("ember").default)}(),"undefined"==typeof FastBoot){var preferNative=!1;(function(e){define("fetch",["exports","ember","rsvp"],(function(t,r,n){"use strict"
...
l.signal&&(l.signal.addEventListener("abort",c),u.onreadystatechange=function(){4===u.readyState&&l.signal.removeEventListener("abort",c)}),u.send(void 0===l._bodyInit?null:l._bodyInit)}))}C.polyfill=!0,t.fetch||(t.fetch=C,t.Headers=m,t.Request=w,t.Response=E),e.Headers=m,e.Request=w,e.Response=E,e.fetch=C})({})
...
const w=null,R="",E=Date.now()
function k(e,t){return`implicit-${e}:${t}${E}`}function C(e,t){e.inverseKind=t.kind,e.inverseKey=t.key,e.inverseType=t.type,e.inverseIsAsync=t.isAsync,e.inverseIsCollection=t.isCollection,e.inverseIsPolymorphic=t.isPolymorphic,e.inverseIsImplicit=t.isImplicit
...
return t.kind=e.kind,t.key=e.name,t.type=e.type,t.isAsync=r.async,t.isImplicit=!1,t.isCollection="hasMany"===e.kind,t.isPolymorphic=r&&!!r.polymorphic,t.inverseKey=r&&r.inverse||R,t.inverseType=R,t.inverseIsAsync=w,t.inverseIsImplicit=r&&null===r.inverse||w,t.inverseIsCollection=w,t.resetOnRemoteUpdate=!r||!1!==r.resetOnRemoteUpdate,t}function T(e,t,r){const n=e.isSelfReferential
...
m=S(t)}else m=null
if(!m){g=k(c,r),m={kind:"implicit",key:g,type:c,isAsync:!1,isImplicit:!0,isCollection:!0,isPolymorphic:!1},C(f,m),C(m,f)
...
return e[t]=i,function(e,t,r){R(e,{op:"replaceRelatedRecord",record:e.identifier,field:e.key,...t},r)}(this,{value:i,prior:r,index:t},s),!0}case"push":{const o=b(n)
...
return function(e,t,r){R(e,{op:"sortRelatedRecords",record:e.identifier,field:e.key,value:t},r)}(this,o.map(i.recordIdentifierFor),s),o}case"splice":{const[o,a,...l]=n
...
if(r(i),i.length!==new Set(i).size){i.filter(((e,t)=>i.indexOf(e)!==t))}}function v(e,t,r){R(e,{op:"addToRelatedRecords",record:e.identifier,field:e.key,...t},r)}function O(e,t,r){R(e,{op:"removeFromRelatedRecords",record:e.identifier,field:e.key,...t},r)}function w(e,t,r){R(e,{op:"replaceRelatedRecords",record:e.identifier,field:e.key,value:t},r)}function R(e,t,r){e._manager.mutate(t),(0,o.addToTransaction)(r)}function E(e,t,r,n,i){var s={}
...
let T=e.P=(k=(0,r.computed)(),E((C=class extends S{get id(){const{key:e,legacySupport:t}=this._belongsToState
return t.referenceFor("belongsTo",e).id()}get meta(){}async reload(e){const{key:t,legacySupport:r}=this._belongsToState
return await r.reloadBelongsTo(t,e),this}}).prototype,"id",[s.cached],Object.getOwnPropertyDescriptor(C.prototype,"id"),C.prototype),E(C.prototype,"meta",[k],Object.getOwnPropertyDescriptor(C.prototype,"meta"),C.prototype),C)
var P
let A=e.a=(E((P=class{constructor(e,t){this._update(e,t),this.isDestroyed=!1}get length(){return this["[]"],this.content?this.content.length:0}forEach(e){this.content&&this.length&&this.content.forEach(e)}reload(e){return this.content.reload(e),this}then(e,t){return this.promise.then(e,t)}catch(e){return this.promise.catch(e)}finally(e){return this.promise.finally(e)}destroy(){this.isDestroyed=!0,this.content=null,this.promise=null}get links(){return this.content?this.content.links:void 0}get meta(){return this.content?this.content.meta:void 0}_update(e,t){void 0!==t&&(this.content=t),this.promise=function(e,t){return e.isPending=!0,e.isSettled=!1,e.isFulfilled=!1,e.isRejected=!1,Promise.resolve(t).then((t=>(e.isPending=!1,e.isFulfilled=!0,e.isSettled=!0,e.content=t,t)),(t=>{throw e.isPending=!1,e.isFulfilled=!1,e.isRejected=!0,e.isSettled=!0,t}))}(this,e)}static create({promise:e,content:t}){return new this(e,t)}}).prototype,"length",[s.compat],Object.getOwnPropertyDescriptor(P.prototype,"length"),P.prototype),E(P.prototype,"links",[s.compat],Object.getOwnPropertyDescriptor(P.prototype,"links"),P.prototype),E(P.prototype,"meta",[s.compat],Object.getOwnPropertyDescriptor(P.prototype,"meta"),P.prototype),P);(0,o.defineSignal)(A.prototype,"content",null),(0,o.defineSignal)(A.prototype,"isPending",!1),(0,o.defineSignal)(A.prototype,"isRejected",!1),(0,o.defineSignal)(A.prototype,"isFulfilled",!1),(0,o.defineSignal)(A.prototype,"isSettled",!1)
...
let x=(E((M=class{constructor(e,t,r,n,i){this.___token=void 0,this.___identifier=void 0,this.___relatedTokenMap=void 0,this.graph=t,this.key=i,this.hasManyRelationship=n,this.type=n.definition.type,this.store=e,this.___identifier=r,this.___token=e.notifications.subscribe(r,((e,t,r)=>{"relationships"===t&&r===i&&this._ref++})),this.___relatedTokenMap=new Map}destroy(){this.store.notifications.unsubscribe(this.___token),this.___relatedTokenMap.forEach((e=>{this.store.notifications.unsubscribe(e)})),this.___relatedTokenMap.clear()}get identifiers(){this._ref
...
const J=u.default
let X=e.E=(H=(0,r.computed)(),V=(0,c.mapBy)("content","message"),G=(0,r.computed)(),W=(0,c.not)("length"),E((Y=class extends J{constructor(...e){super(...e),q(this,"messages",K,this),q(this,"isEmpty",Q,this)}get errorsByAttributeName(){return new Map}errorsFor(e){const t=this.errorsByAttributeName
let n=t.get(e)
...
return a&&i.push.apply(i,a),e.superclass&&we(e.superclass,t,r,i),i}function Re(e,t,r){const n=new WeakMap,i=r.get
...
return this.eachAttribute(((t,r)=>{r.type&&e.set(t,r.type)})),e}static eachAttribute(e,t){this.attributes.forEach(((r,n)=>{e.call(t,n,r)}))}static eachTransformedAttribute(e,t){this.transformedAttributes.forEach(((r,n)=>{e.call(t,n,r)}))}static toString(){return`model:${this.modelName}`}}).isModel=!0,Oe.modelName=null,E((ve=Oe).prototype,"isEmpty",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"isEmpty"),ve.prototype),E(ve.prototype,"isLoading",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"isLoading"),ve.prototype),E(ve.prototype,"isLoaded",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"isLoaded"),ve.prototype),E(ve.prototype,"hasDirtyAttributes",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"hasDirtyAttributes"),ve.prototype),E(ve.prototype,"isSaving",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"isSaving"),ve.prototype),E(ve.prototype,"isDeleted",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"isDeleted"),ve.prototype),E(ve.prototype,"isNew",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"isNew"),ve.prototype),E(ve.prototype,"isValid",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"isValid"),ve.prototype),E(ve.prototype,"dirtyType",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"dirtyType"),ve.prototype),E(ve.prototype,"isError",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"isError"),ve.prototype),E(ve.prototype,"id",[ge],Object.getOwnPropertyDescriptor(ve.prototype,"id"),ve.prototype),E(ve.prototype,"currentState",[ge],Object.getOwnPropertyDescriptor(ve.prototype,"currentState"),ve.prototype),E(ve.prototype,"errors",[Re],Object.getOwnPropertyDescriptor(ve.prototype,"errors"),ve.prototype),E(ve.prototype,"adapterError",[s.compat],Object.getOwnPropertyDescriptor(ve.prototype,"adapterError"),ve.prototype),E(ve,"inverseMap",[Re],Object.getOwnPropertyDescriptor(ve,"inverseMap"),ve),E(ve,"relationships",[Re],Object.getOwnPropertyDescriptor(ve,"relationships"),ve),E(ve,"relationshipNames",[Re],Object.getOwnPropertyDescriptor(ve,"relationshipNames"),ve),E(ve,"relatedTypes",[Re],Object.getOwnPropertyDescriptor(ve,"relatedTypes"),ve),E(ve,"relationshipsByName",[Re],Object.getOwnPropertyDescriptor(ve,"relationshipsByName"),ve),E(ve,"relationshipsObject",[Re],Object.getOwnPropertyDescriptor(ve,"relationshipsObject"),ve),E(ve,"fields",[Re],Object.getOwnPropertyDescriptor(ve,"fields"),ve),E(ve,"attributes",[Re],Object.getOwnPropertyDescriptor(ve,"attributes"),ve),E(ve,"transformedAttributes",[Re],Object.getOwnPropertyDescriptor(ve,"transformedAttributes"),ve),ve)
...
return r||`@lid:${t}-${e.id}`}return O.randomUUID()}if("document"===t)return e.url?e.method&&"GET"!==e.method.toUpperCase()?null:e.url:null}function M(...e){}function x(e,t,r){return e}class j{constructor(){this._generate=R||A,this._update=k||T,this._forget=w||M,this._reset=E||M,this._merge=x,this._keyInfoForResource=P,this._isDefaultConfig=!R,this._id=S++,this._cache={resources:new Map,resourcesByType:Object.create(null),documents:new Map,polymorphicLidBackMap:new Map}}__configureMerge(e){this._merge=e||x}upgradeIdentifier(e){return this._getRecordIdentifier(e,2)}_getRecordIdentifier(e,t){if(_(e))return e
...
const Re={enumerable:!0,configurable:!1,get:function(){return this}};(0,l.compat)(Re),Object.defineProperty(we.prototype,"[]",Re),(0,o.defineSignal)(we.prototype,"isUpdating",!1)
...
return this._managed.add(r),this._set.set(r,new Set(t.identifiers||[])),e.identifiers&&Pe(this._identifiers,r,e.identifiers),r}dirtyArray(e,t){if(e===ke)return
const r=e[me]
